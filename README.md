...
- Lifecycle playbook: [Make Docs Lifecycle Playbook](docs/library/playbooks/agent-maintainer/make-docs-lifecycle.md) for agent/maintainer phase routing from inputs through retrospective.
