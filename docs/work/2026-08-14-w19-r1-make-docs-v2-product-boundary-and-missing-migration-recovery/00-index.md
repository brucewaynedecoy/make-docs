...
| [06-global-store-evolution.md](./06-global-store-evolution.md) | W19 R1 P6 | P5 complete; P6 remains separately gated | Add transactional `runs` and `run_evidence` while preserving legacy state opaquely. |
