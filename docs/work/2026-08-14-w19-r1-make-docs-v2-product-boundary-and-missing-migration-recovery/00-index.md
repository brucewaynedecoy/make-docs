...
| [04-manifest-setup-reconfiguration-and-routers.md](./04-manifest-setup-reconfiguration-and-routers.md) | W19 R1 P4 | Correction complete and owner-accepted through `2f36f72` | Corrected authority is at `40c4d231`, content-package retirement is at `e1bbec04`, runtime repair is at `315dce5d`, full smoke proof is at `8763e9b`, and the owner-approved router line cap is at `2f36f72`. |
...
| [07-naive-uat-workflow-persona-and-evidence.md](./07-naive-uat-workflow-persona-and-evidence.md) | W19 R1 P7 | P4 dependency re-proved at `2f36f72`; final baseline binds to the closeout commit before review resumes at D-005 | `P7-AUTHORITY` is accepted. D-005 and P7-BUDGET remain open. Persona, scenario, risk, and six-operation meaning remain unchanged. P7 implementation is not authorized. |
