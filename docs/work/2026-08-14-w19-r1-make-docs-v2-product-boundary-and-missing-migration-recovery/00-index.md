...
| [02-resource-identity-and-resolver-core.md](./02-resource-identity-and-resolver-core.md) | W19 R1 P2 | Depends on P1 | Implement stable identity, providers, resolution, provenance, path safety, and typed resource operations. |
| [03-operation-registry-cli-and-mcp.md](./03-operation-registry-cli-and-mcp.md) | W19 R1 P3 | Depends on P2 | Project the typed resource, run, and Naive-UAT operations consistently through CLI and MCP. |
| [04-manifest-setup-reconfiguration-and-routers.md](./04-manifest-setup-reconfiguration-and-routers.md) | W19 R1 P4 | Depends on P2 and P3 | Implement selections, ownership, dry-run lifecycle plans, routers, optional projection, and receipts. |
| [05-compatibility-quiescence-backup-and-migration.md](./05-compatibility-quiescence-backup-and-migration.md) | W19 R1 P5 | Depends on P2 through P4 | Implement compatibility classification, quiescence, backup/rollback, and the accepted migration order. |
| [06-global-store-evolution.md](./06-global-store-evolution.md) | W19 R1 P6 | Depends on P5 safety primitives | Add transactional `runs` and `run_evidence` while preserving legacy state opaquely. |
| [07-naive-uat-workflow-persona-and-evidence.md](./07-naive-uat-workflow-persona-and-evidence.md) | W19 R1 P7 | Depends on P1 through P6 | Deliver the system workflow, Persona resolution, thin Skill, evidence routing, findings, and gates. |
