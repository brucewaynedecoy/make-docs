...
| [05-compatibility-quiescence-backup-and-migration.md](./05-compatibility-quiescence-backup-and-migration.md) | W19 R1 P5 | Phase-entry gate complete; implementation separately gated | Implement compatibility classification, quiescence, backup/rollback, and the accepted migration order. |
