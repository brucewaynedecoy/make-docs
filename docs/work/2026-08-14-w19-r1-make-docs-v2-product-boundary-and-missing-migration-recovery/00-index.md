...
| [04-manifest-setup-reconfiguration-and-routers.md](./04-manifest-setup-reconfiguration-and-routers.md) | W19 R1 P4 | Complete and owner-accepted; pushed through `efebfa29` | Implement selections, ownership, dry-run lifecycle plans, routers, optional projection, and receipts. |
