...
| [04-manifest-setup-reconfiguration-and-routers.md](./04-manifest-setup-reconfiguration-and-routers.md) | W19 R1 P4 | Documentation-surface recovery reopened at baseline `90b4fd8` | D-030 keeps D-029 closed and separately corrects the omitted documentation-router topology. Authority correction is first. Runtime, tests, generated output, fresh review, acceptance, and final corrective closeout remain pending. |
...
| [07-naive-uat-workflow-persona-and-evidence.md](./07-naive-uat-workflow-persona-and-evidence.md) | W19 R1 P7 | Paused for D-030 documentation-surface recovery | `P7-AUTHORITY` is accepted. D-005 and P7-BUDGET remain open. Persona, scenario, risk, and six-operation meaning remain unchanged. After accepted P4 recovery and final closeout, refresh the baseline and dependency proof and resume at D-005 without restarting preflight. P7 implementation is not authorized. |
