...
follow_on:
  ...
  why: "P8 Stage 1 source and isolated proof pass. The exact package and installed proof remain separately gated."
  coordinate_handoff: "Carry W22 R0 P8 into Stage 2 only after separate owner approval."
---
...
P8 is active. The owner approved Stage 1 implementation on 2026-09-23. Target-scoped router ownership and the reviewed reinstall handoff now pass in source and isolated fixtures. Stage 2 is not authorized. P7, P8, D-038, and W22 remain open.
...
| HX-5: setup and repair use one open recovery path | Same | PRDs 07, 18, 38, and 39 after P8 authority maintenance | [P4](04-harness-trust-setup-and-resource-simplification.md), [P5](05-compatibility-bridge-and-symptom-closure.md), [P7](07-setup-bridge-order-and-recovery-loop-repair.md), and [P8](08-router-ownership-and-reviewed-reinstall-repair.md) | State-transition tests, interruption/restart proof, exact loop regression, router-preservation proof, and installed transcripts | A22-A26, A31-A34, A45-A56, and A57-A62 pass | None |
...
- P1 through P6 and the prior P7 source results are completed records for their exact evidence. P7 remains open. P8 Stage 1 passes in source. Stage 2 remains separately gated.
...
- Route: `implementation-loop`
- Next step: Review the P8 Stage 1 source result. If the owner approves it, build one exact Stage 2 package candidate.
...
Reopening the completed wave and adding P8 are explicit lifecycle departures. The product-authority update records the new defect without closing or rewriting P7. P8 Stage 1 source work is complete. P7, P8, D-038, and W22 remain open. Staging, commit, push, package installation, live setup, and closeout remain separate gates.
