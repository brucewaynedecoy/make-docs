...
3. The later W23-bearing CLI used for this invalidated fixture converts the Store to schema 6 before machine apply. It repairs Codex, adds Claude, preserves the user-owned Codex model and Claude theme, and applies project work only after its separate approval. This is historical defect evidence. The isolated P7 candidate starts from `main`, targets Store schema 5, and needs separate exact-candidate proof.
