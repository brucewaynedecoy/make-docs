...
- [ ] If implementing a plugin, satisfy PRD 30 payload, native exposure or plugin-specific adapter, explicit selection, audit, backup, uninstall, and support metadata boundaries.
