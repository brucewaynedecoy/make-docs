...
- `./.make-docs/build-process/` is not currently materialized in this worktree, so the phase follows [../../AGENTS.md](../../AGENTS.md) and [../../../.make-docs/references/system/lifecycle.md](../../../.make-docs/system/references/lifecycle.md). This is an explicit lifecycle departure from the requested numbered build-process directory, not an implicit skip.
