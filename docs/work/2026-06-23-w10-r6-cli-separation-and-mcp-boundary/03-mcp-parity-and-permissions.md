...
| Task | Evidence |
| --- | --- |
| t1 | Added [CLI/MCP Operation Parity and Permissions](../../assets/maintainer/cli-mcp-operation-parity-and-permissions.md), which maps planned MCP capability labels to CLI/shared-core owners and states that labels are not shipped tool ids. |
...
- Developer-guide coverage: created [CLI/MCP Operation Parity and Permissions](../../assets/maintainer/cli-mcp-operation-parity-and-permissions.md) and linked it from [Building and Installing the CLI Locally](../../assets/maintainer/cli-development-local-build-and-install.md) plus [Packaging, Validation, and Release Reference](../../assets/maintainer/release-packaging-validation-and-release-reference.md).
