...
- Developer-guide coverage: updated [Building and Installing the CLI Locally](../../assets/maintainer/cli-development-local-build-and-install.md) because maintainers need the current TypeScript-only boundary and future Rust/MCP caveat while validating local CLI changes.
- User-guide coverage: updated [Managing Installations with the Make Docs CLI](../../assets/user/cli-lifecycle-managing-installations.md), [Installing Make Docs](../../assets/user/getting-started-installing-make-docs.md), [Installing and Managing Skills](../../assets/user/skills-installing-and-managing-skills.md), and [Decomposing an Existing Codebase](../../assets/user/skills-decomposing-an-existing-codebase.md) because users need corrected command examples, supported dry-run guidance, and the current npm/TypeScript command boundary.
