...
- [PRD 28](../../prd/28-shared-agentics-installation-and-harness-exposure.md), [PRD 03](../../prd/03-open-questions-and-risk-register.md), [PRD 07](../../prd/07-cli-command-surface-and-lifecycle.md), [PRD 08](../../prd/08-skills-catalog-and-distribution.md), [PRD 10](../../prd/10-packaging-validation-and-release-reference.md), and [PRD 30](../../prd/30-plugin-substrate-and-workflow-bundles.md) all name W17 R3 native exposure, symlink preference, managed copy-mirror fallback, or legacy generated-stub classification where relevant.
