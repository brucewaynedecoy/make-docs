...
| [docs/.references/agent-guide-contract.md](../../.references/agent-guide-contract.md) | Updated history record contract for the future `.assets/history` namespace. |
| [docs/.templates/agent-guide.md](../../.templates/agent-guide.md) | Added the flexible frontmatter scaffold for history records. |
| [docs/.prompts/session-to-agent-guide.prompt.md](../../.prompts/session-to-agent-guide.prompt.md) | Rerouted session summaries to `docs/.assets/history/`. |
