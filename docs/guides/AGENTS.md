...
- Agent session summaries — point-in-time breadcrumbs written at the end of a work session — are stored in `docs/guides/agent`. Read `docs/guides/agent/AGENTS.md` before writing.
