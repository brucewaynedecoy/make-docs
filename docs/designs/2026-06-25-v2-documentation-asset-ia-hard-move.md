...
Source Inputs: [evolution-direction-structure.md](../assets/project/evolution-direction-structure.md), [v2 Proposed Design and Roadmap](../assets/project/v2-proposed-design-and-roadmap.md)
