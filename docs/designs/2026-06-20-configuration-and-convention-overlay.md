...
The evidence pass found no existing active design that should be updated in place. The closest same-area prior design is [Make Docs Lifecycle Playbook and Terminology Overlay](2026-05-28-make-docs-lifecycle-playbook.md), but that design captured broader terminology-overlay intent before the accepted v2 Batch 2 model narrowed configuration to presentation behavior. This v2 planning pass therefore creates a new dated design rather than mutating the older document.
...
Prior Design Docs: [Tool Directory System and Custom Resource Tiers](2026-06-19-tool-directory-system-and-custom-resource-tiers.md), [New Docs Assets, Playbooks, and Persona Model](2026-06-19-new-docs-assets-playbooks-and-persona-model.md), [Generated Metadata and Lifecycle Handoffs](2026-06-20-generated-metadata-and-lifecycle-handoffs.md), [Make Docs Lifecycle Playbook and Terminology Overlay](2026-05-28-make-docs-lifecycle-playbook.md)
