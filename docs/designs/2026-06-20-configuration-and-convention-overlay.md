...
The evidence pass found no existing active design that should be updated in place. The closest same-area prior design is [Make Docs Lifecycle Playbook and Terminology Overlay](../../.make-docs/archive/designs/2026-05-28-make-docs-lifecycle-playbook.md), but that design captured broader terminology-overlay intent before the accepted v2 Batch 2 model narrowed configuration to presentation behavior. This v2 planning pass therefore creates a new dated design rather than mutating the older document.
...
This design is a lifecycle departure by direction: it is generated from artifact roadmap inputs before the workflow returns to design -> plan -> PRD -> work -> implementation. The departure is the accepted `source-to-design-straddle` described by [lifecycle.md](../../.make-docs/system/references/lifecycle.md); it is explicit here so the later plan can resume the normal lifecycle instead of silently treating artifact proposals as implementation authority.
...
Prior Design Docs: [Tool Directory System and Custom Resource Tiers](2026-06-19-tool-directory-system-and-custom-resource-tiers.md), [New Docs Assets, Playbooks, and Persona Model](2026-06-19-new-docs-assets-playbooks-and-persona-model.md), [Generated Metadata and Lifecycle Handoffs](2026-06-20-generated-metadata-and-lifecycle-handoffs.md), [Make Docs Lifecycle Playbook and Terminology Overlay](../../.make-docs/archive/designs/2026-05-28-make-docs-lifecycle-playbook.md)
