...
- `docs/assets/archive/history/` for point-in-time history records
...
| History | Record what happened at a point in time | History records live under `docs/assets/archive/history/` and carry W/R/P in frontmatter and filename only when known. |
