...
- Blocked by: W18 R8 Phase 5 (tests and verification). Update when: the consolidated D10 verification suite lands. Guide change: update the Validation section with any coverage the D10 pass adds or reorganizes beyond the per-phase suites documented above.
