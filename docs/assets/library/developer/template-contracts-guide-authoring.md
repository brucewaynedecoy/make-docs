...
This guide is for maintainers who add or update files under `docs/assets/library/developer/` and `docs/assets/library/user/`.
...
- `docs/assets/library/user/` for user-facing guidance
- `docs/assets/library/developer/` for maintainer and contributor guidance
...
Publication routing is driven by `path`, not by creating nested folders under the persona directories. Keep guide files directly in `docs/assets/library/user/` or `docs/assets/library/developer/`.
...
- `docs/assets/library/AGENTS.md` keeps guide work inside the user or developer guide families
