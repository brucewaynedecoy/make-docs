...
| `docs/assets/archive/history/` | Yes, when known | History records often capture phase-scoped progress. |
...
| History record | `docs/assets/archive/history/2026-04-23-w13-r0-p3-user-guide-delivery.md` |
