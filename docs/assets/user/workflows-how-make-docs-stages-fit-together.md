...
related:
  ...
  - "../../../.make-docs/archive/legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md"
  - "concepts-wave-revision-phase-coordinates.md"
  - "getting-started-installing-make-docs.md"
  - "../maintainer/development-workflows-stage-model-and-artifact-relationships.md"
...
- Use [Running Make Docs Playbooks](../../../.make-docs/archive/legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) when you want to understand planned runnable workflow behavior on top of the stage model.
- Use [Installing Make Docs](getting-started-installing-make-docs.md) when you still need to set up the system in a repo.
- Use the companion developer guide [Understanding the Make Docs Stage Model](../maintainer/development-workflows-stage-model-and-artifact-relationships.md) for the contributor-facing version of the same model.
