...
related:
  ...
  - "../maintainer/development-workflows-choosing-the-right-route.md"
...
- Use the companion developer guide [Choosing the Right Make Docs Route](../maintainer/development-workflows-choosing-the-right-route.md) for the maintainer-facing decision model.
