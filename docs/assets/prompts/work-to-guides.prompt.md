...
Before writing anything, read `docs/assets/references/coverage-pass-contract.md`, `docs/assets/references/guide-contract.md`, the matching guide template in `docs/assets/templates/`, and the router in `docs/guides/`. Treat those files as the authority for coverage-pass mechanics, audience intent, frontmatter, slug rules, guide coverage decisions, and future coverage handling.
