...
- `python3 .agents/skills/closeout-phase/scripts/work_phase_state.py docs/assets/archive/work/2026-05-06-w14-r2-cli-conflict-resolution/02-conflict-model-and-planner.md --json`
