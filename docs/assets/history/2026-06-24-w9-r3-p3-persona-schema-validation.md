...
| Path | Description |
| --- | --- |
| [../references/coverage-pass-contract.md](../references/coverage-pass-contract.md) | Defines configured persona target slugs and keeps verdict and persona-target axes separate. |
