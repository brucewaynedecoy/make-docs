...
- Read [AGENTS.md](AGENTS.md) before writing or editing files under `docs/assets/artifacts/`, and treat artifact files as zero-contract seed material.
- Before generating a design doc, read `docs/designs/AGENTS.md`, `.make-docs/contracts/system/design-contract.md`, `.make-docs/references/system/design-workflow.md`, `.make-docs/templates/system/design.md`, and `.make-docs/references/system/lifecycle.md`.
...
We are preparing v2 design docs from `docs/assets/artifacts/v2-proposed-design-and-roadmap.md`. Focus only on `{batch_name}`.
...
2. Read the v2 roadmap inputs:
   - `docs/assets/artifacts/v2-proposed-design-and-roadmap.md`
   - `docs/assets/artifacts/evolution-direction.md`
   - `docs/assets/artifacts/evolution-direction-structure.md`
   - `docs/assets/artifacts/lifecycle-and-coverage.md`
...
1. Read the repo and design instructions:
   ...
   - `.make-docs/references/system/design-workflow.md`
   - `.make-docs/templates/system/design.md`
2. Read the governing roadmap sections in `docs/assets/artifacts/v2-proposed-design-and-roadmap.md`.
...
1. Re-read the accepted evidence source and the relevant section of `docs/assets/artifacts/v2-proposed-design-and-roadmap.md`.
2. Re-read `docs/designs/AGENTS.md`, `.make-docs/contracts/system/design-contract.md`, `.make-docs/references/system/design-workflow.md`, `.make-docs/templates/system/design.md`, and `.make-docs/references/system/lifecycle.md`.
...
2. Read `docs/assets/artifacts/v2-proposed-design-and-roadmap.md` and compare the accepted batch output to the intended batch goals.
3. Re-read `.make-docs/references/system/lifecycle.md`, `.make-docs/contracts/system/design-contract.md`, and `.make-docs/references/system/design-workflow.md`.
...
- `git diff --check -- docs/assets/artifacts/v2-design-generation-prompts.md`
- A changed-file Markdown link check for `docs/assets/artifacts/v2-design-generation-prompts.md`
