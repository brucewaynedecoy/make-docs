...
| --- | --- | --- | --- | --- | --- |
| [Installing Make Docs](../../../../library/user/getting-started-installing-make-docs.md) | user | `getting-started` | `draft` | install, sync, first-run defaults, capability reference, command reference, troubleshooting | Strong overlap with install, sync, reconfigure, and basic CLI lifecycle surfaces; likely too broad once dedicated CLI guides exist |
| [Understanding W/R/P Coordinates](../../../../library/user/concepts-wave-revision-phase-coordinates.md) | user | `concepts` | `draft` | coordinate semantics, where coordinates appear, commit-message usage | Solid concept coverage, but needs alignment with the broader stage-model and route-selection guide set |
| [How Make Docs Stages Fit Together](../../../../library/user/workflows-how-make-docs-stages-fit-together.md) | user | `workflows` | `draft` | stage sequence, route overview, full-vs-delta outcomes | Partial overlap with route-selection guides; decomposition terminology may need tightening after `W12 R0` |
| [Choosing the Right Route for Your Project](../../../../library/user/workflows-choosing-the-right-route-for-your-project.md) | user | `workflows` | `draft` | route selection for baseline PRDs, decomposition, targeted PRD updates, and backlog scope | Strong overlap with the developer route guide; likely needs clearer cross-links instead of duplicated prose |
| [Building and Installing the CLI Locally](../../../../library/developer/cli-development-local-build-and-install.md) | developer | `cli/development` | `draft` | local build, test, instruction-router validation, smoke-pack, npm link and npm pack workflows | Mixes local CLI development with broader validation and release concerns that likely deserve separate maintainer or release guides |
| [Understanding the Make Docs Stage Model](../../../../library/developer/development-workflows-stage-model-and-artifact-relationships.md) | developer | `development/workflows` | `draft` | stage model, artifact relationships, lifecycle rules, contributor implications | Strong partial overlap with coordinate and route guides; should stay as the maintainer-facing workflow explainer |
| [Choosing the Right Make Docs Route](../../../../library/developer/development-workflows-choosing-the-right-route.md) | developer | `development/workflows` | `draft` | route decision table, baseline generation, decomposition, active-set evolution, W/R follow-up work | Overlaps with the user route guide; good candidate for shared cross-linking instead of standalone expansion |
| [Strategic Roadmap — Skills, Agentics, Multi-Harness, and Extensibility](../../../../library/developer/roadmap.md) | developer | `roadmap` | `draft` | strategic direction for skills packaging, multi-harness support, and extensibility | Intentionally strategic, not operational; should not absorb maintainer, release, or skill-usage guides |
...
- `evidence links`: [Guide Structure Contract design](../../../designs/2026-04-16-guide-structure-contract.md), [W2 R0 plan](../../../plans/2026-04-16-w2-r0-guide-structure-contract/00-overview.md), [W2 R0 work](../../2026-04-16-w2-r0-guide-structure-contract/00-index.md), [W2 history](../../../history/2026-04-16-w2-r0-p1-guide-structure-contract.md), [guide contract reference](../../../../../../.make-docs/contracts/system/guide-contract.md).
...
- `related docs`: [guides router](../../../../library/AGENTS.md), guide developer template (historical path: `../../../../templates/guide-developer.md`), guide user template (historical path: `../../../../templates/guide-user.md`), [history record contract](../../../../../../.make-docs/contracts/system/history-record-contract.md).
...
- `evidence links`: [Docs Contract v2 — Planning Proposals](../../../../../designs/2026-04-15-docs-contract-v2-planning.md), [Design Naming Simplification design](../../../designs/2026-04-16-design-naming-simplification.md), [W3 R0 plan](../../../plans/2026-04-16-w3-r0-design-naming-simplification/00-overview.md), [W3 R0 work](../../2026-04-16-w3-r0-design-naming-simplification/00-index.md), [user coordinate guide](../../../../library/user/concepts-wave-revision-phase-coordinates.md), [developer stage-model guide](../../../../library/developer/development-workflows-stage-model-and-artifact-relationships.md), [wave-model reference](../../../../../../.make-docs/references/system/wave-model.md).
...
- `related docs`: [user stage workflow guide](../../../../library/user/workflows-how-make-docs-stages-fit-together.md), [PRD index](../../../../../prd/00-index.md), [01 Product Overview](../../../../../prd/01-product-overview.md), [02 Architecture Overview](../../../../../prd/02-architecture-overview.md).
...
- `related docs`: [current `cli.ts`](../../../../../../packages/cli/src/cli.ts), [10 Packaging, Validation, and Release Reference](../../../../../prd/10-packaging-validation-and-release-reference.md), [history W7 R0 P3](../../../history/2026-04-18-w7-r0-p3-cli-help-backup-and-uninstall.md).
...
- `existing guide overlap`: Only strategic overlap in [roadmap](../../../../library/developer/roadmap.md). No current guide explains how to use or maintain the skills lifecycle surface.
- `final outcome`: `both`
- `guide family`: `skills`
...
- `related docs`: [07 CLI Command Surface and Lifecycle](../../../../../prd/07-cli-command-surface-and-lifecycle.md), [roadmap](../../../../library/developer/roadmap.md), [current `cli.ts`](../../../../../../packages/cli/src/cli.ts).
...
- `evidence links`: [Archive Docs — Relationship-Aware Document Archival Plugin](../../../designs/2026-04-16-archive-docs-skill.md), [W5 R0 plan](../../../plans/2026-04-16-w5-r0-archive-docs-plugin/00-overview.md), [W5 R0 work](../../2026-04-16-w5-r0-archive-docs-plugin/00-index.md), [W5 history](../../../history/2026-04-16-w5-r0-p1-archive-docs-plugin.md), [08 Skills Catalog and Distribution](../../../../../prd/08-skills-catalog-and-distribution.md), [roadmap](../../../../library/developer/roadmap.md).
...
- `related docs`: [current `skill-registry.ts`](../../../../../../packages/cli/src/skill-registry.ts), [packages/skills/archive-docs](../../../../../../packages/skills/archive-docs), [guide roadmap](../../../../library/developer/roadmap.md).
...
- `related docs`: [guide contract reference](../../../../../../.make-docs/contracts/system/guide-contract.md), [execution workflow reference](../../../../../../.make-docs/references/system/execution-workflow.md), [packages/docs/README.md](../../../../../../packages/docs/README.md), [packages/docs/template](../../../../../../packages/docs/template).
...
- `evidence links`: [Docs Assets, Make-Docs State, and Session History](../../../designs/2026-04-20-docs-assets-state-and-history.md), [Docs Assets Resource Namespace Overhaul](../../../designs/2026-04-22-docs-assets-resource-namespace.md), [W9 R0 work](../../2026-04-20-w9-r0-docs-assets-state-and-history/00-index.md), [W9 R1 work](../../2026-04-22-w9-r1-docs-assets-resource-namespace/00-index.md), [W10 history](../../../history/2026-04-21-w10-r0-p3-docs-history-and-pathnames.md), [history record contract](../../../../../../.make-docs/contracts/system/history-record-contract.md), current `renderers.ts` (historical path: `../../../../../../packages/cli/src/renderers.ts`), [current `audit.ts`](../../../../../../packages/cli/src/audit.ts).
...
- `related docs`: [current root README](../../../../../../README.md), [packages/docs/README.md](../../../../../../packages/docs/README.md), [guide installing make-docs](../../../../library/user/getting-started-installing-make-docs.md).
...
- `evidence links`: [Make Docs Rename](../../../designs/2026-04-21-make-docs-rename.md), [W10 R0 plan](../../../plans/2026-04-21-w10-r0-make-docs-rename/00-overview.md), [W10 R0 work](../../2026-04-21-w10-r0-make-docs-rename/00-index.md), [Building and Installing the CLI Locally](../../../../library/developer/cli-development-local-build-and-install.md), [09 Dogfood and Maintainer Operations](../../../../../prd/09-dogfood-and-maintainer-operations.md), [10 Packaging, Validation, and Release Reference](../../../../../prd/10-packaging-validation-and-release-reference.md), [current `utils.ts`](../../../../../../packages/cli/src/utils.ts), [packages/docs/README.md](../../../../../../packages/docs/README.md).
...
- `related docs`: [roadmap](../../../../library/developer/roadmap.md), [current root README](../../../../../../README.md), [packages/cli/package.json](../../../../../../packages/cli/package.json), [scripts/smoke-pack.mjs](../../../../../../scripts/smoke-pack.mjs).
