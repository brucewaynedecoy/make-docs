...
| [03-asset-normalization-and-compatibility.md](./03-asset-normalization-and-compatibility.md) | Remove asset-selection fields from installer state, keep assets always managed, and reject stale manifests with rebuild guidance. |
...
- Phases 2 and 3 may run in parallel only after their owners agree on the alpha cleanup shape for legacy flags, stale manifests, and shared selection types.
