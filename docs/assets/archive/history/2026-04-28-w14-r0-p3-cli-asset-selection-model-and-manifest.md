...
| packages/cli/src/renderers.ts | Renderer wording now refers to required planning prompts rather than optional prompt starters. |
...
| packages/cli/tests/renderers.test.ts | Renderer tests updated for current prompt guidance. |
| [docs/work/2026-04-28-w14-r0-cli-asset-selection-simplification/03-asset-normalization-and-compatibility.md](../work/2026-04-28-w14-r0-cli-asset-selection-simplification/03-asset-normalization-and-compatibility.md) | Phase 3 backlog item implemented by selection-model, manifest, rules, and test updates. |
