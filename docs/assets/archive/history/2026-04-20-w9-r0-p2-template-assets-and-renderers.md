...
Completed Wave 9 Phase 2, framed by [the Phase 2 plan](../archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md) and [the Phase 2 backlog](../archive/work/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md). This phase closed the template asset and renderer coverage for the new `.assets` namespace and confirmed fresh installs no longer create `docs/guides/agent/`.
...
| Path | Description |
| --- | --- |
| [docs/assets/archive/work/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md](../archive/work/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md) | Phase 2 work item with acceptance criteria marked complete. |
