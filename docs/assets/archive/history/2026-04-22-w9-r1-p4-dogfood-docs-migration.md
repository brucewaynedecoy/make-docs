...
| Path | Description |
| --- | --- |
| [docs/guides/developer/cli-development-local-build-and-install.md](../../library/developer/cli-development-local-build-and-install.md) | Updated smoke-pack guidance to assert `.make-docs/manifest.json`. |

### User

| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-make-docs.md](../../library/user/getting-started-installing-make-docs.md) | Updated manifest and conflict staging guidance to use root `.make-docs/` state. |
