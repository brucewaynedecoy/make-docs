...
| [packages/docs/template/docs/assets/library/](../../../../packages/docs/template/docs/assets/library/) | Updated guide router references to the new template support-resource paths. |
...
| [docs/assets/archive/work/2026-04-22-w9-r1-docs-assets-resource-namespace/02-template-resource-tree.md](../work/2026-04-22-w9-r1-docs-assets-resource-namespace/02-template-resource-tree.md) | Marked Phase 2 work tasks and acceptance criteria complete. |
