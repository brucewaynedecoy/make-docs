...
| Path | Description |
| --- | --- |
| docs/library/playbooks/agent/make-docs-lifecycle.md (historical path: `../../playbooks/agent/make-docs-lifecycle.md`) | Renamed to the `agent` persona; `persona:` frontmatter and prose corrected. |
