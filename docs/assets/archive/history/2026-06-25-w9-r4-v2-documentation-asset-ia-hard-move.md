...
| Area | Summary |
| --- | --- |
| Authority | [historical closeout](2026-06-24-w9-r2-p4-validation-closeout.md) (retired action-PRD: `docs/prd/21-revise-tool-directory-system-custom-resource-tiers.md`), [historical closeout](2026-06-24-w9-r3-p4-package-parity-closeout.md) (retired action-PRD: `docs/prd/22-revise-new-docs-assets-playbooks-persona-model.md`), and [R-013](../../../prd/03-open-questions-and-risk-register.md#r-013-the-restructure-and-rename-will-relocate-newly-authored-assets) now reflect the hard-move IA and close the broad relocation risk. |
