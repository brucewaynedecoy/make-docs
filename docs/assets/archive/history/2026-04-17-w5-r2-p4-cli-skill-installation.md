...
| Path | Description |
| --- | --- |
| [docs/assets/archive/work/2026-04-16-w5-r2-cli-skill-installation/04-skill-install-pipeline.md](../work/2026-04-16-w5-r2-cli-skill-installation/04-skill-install-pipeline.md) | Work backlog phase — defines the five stage rollout for the harness-aware skill install pipeline that this session completed. |
| [docs/assets/archive/plans/2026-04-16-w5-r2-cli-skill-installation/04-skill-install-pipeline.md](../plans/2026-04-16-w5-r2-cli-skill-installation/04-skill-install-pipeline.md) | Source plan — specifies the new `skill-catalog.ts`, planner/install integration, manifest `skillFiles` behavior, and acceptance criteria for skill path rewriting and reconfigure removal. |
