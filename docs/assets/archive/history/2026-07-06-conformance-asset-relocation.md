...
| [PRD 42](../../../prd/42-revise-conformance-asset-home-relocation.md) (new) | Revision against PRD 37, location only: the mandated home revises to repo-root `conformance/`; queryability, statuses, derivation rules, evidence bar, and the maintainer-only never-shipped boundary unchanged. |
| Change notes | PRD 37 (The Tuple Registry, Contracts and Data), [PRD 20](../../../prd/20-revise-agent-harness-model-conformance-lab.md) (Effective Requirement notes), and [PRD 33](../../../prd/33-enhance-playbook-packaging-and-harness-adapter-registry.md) (Integration Impact notes) each carry a `Superseded by` note scoped to the location; nothing renumbered. |
...
| Path | Description |
| --- | --- |
| [docs/prd/42-revise-conformance-asset-home-relocation.md](../../../prd/42-revise-conformance-asset-home-relocation.md) | New revision change doc relocating the conformance asset home to repo-root `conformance/`. |
...
| [docs/prd/37-enhance-playbook-and-package-conformance.md](../../../prd/37-enhance-playbook-and-package-conformance.md) | `Superseded by` change notes under The Tuple Registry and Contracts and Data. |
| [docs/prd/20-revise-agent-harness-model-conformance-lab.md](../../../prd/20-revise-agent-harness-model-conformance-lab.md) | Location-scoped `Superseded by` note appended to the existing change notes. |
| [docs/prd/33-enhance-playbook-packaging-and-harness-adapter-registry.md](../../../prd/33-enhance-playbook-packaging-and-harness-adapter-registry.md) | Registry-home-scoped `Superseded by` note appended. |
