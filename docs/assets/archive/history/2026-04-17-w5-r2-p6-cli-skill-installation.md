...
| [docs/assets/archive/designs/2026-04-16-cli-skill-installation-r2.md](../archive/designs/2026-04-16-cli-skill-installation-r2.md) | Rewrote the living R2 design doc to reflect the final shipped model: remote-only registry sources, `archive-docs` as a single required skill, directory installs under `.claude/skills/<name>/` and `.agents/skills/<name>/`, and canonical phase-6 CLI flags. |
...
| [docs/assets/archive/plans/2026-04-16-w5-r2-cli-skill-installation/00-overview.md](../archive/plans/2026-04-16-w5-r2-cli-skill-installation/00-overview.md), [docs/assets/archive/plans/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md](../archive/plans/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md), [docs/assets/archive/work/2026-04-16-w5-r2-cli-skill-installation/00-index.md](../archive/work/2026-04-16-w5-r2-cli-skill-installation/00-index.md), and [docs/assets/archive/work/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md](../archive/work/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md) | Added concise divergence notes so the historical `w5-r2` plan/work backlog remains readable without pretending the earlier `local:`/staging/flat-skill assumptions were the final implementation. |
...
| Path | Description |
| --- | --- |
| [docs/assets/archive/designs/2026-04-16-cli-skill-installation-r2.md](../archive/designs/2026-04-16-cli-skill-installation-r2.md) | Living design source updated to the final remote single-skill model and the canonical phase-6 CLI surface. |
| [docs/assets/archive/plans/2026-04-16-w5-r2-cli-skill-installation/00-overview.md](../archive/plans/2026-04-16-w5-r2-cli-skill-installation/00-overview.md) | Plan entrypoint updated with an implemented-divergence note so readers do not mistake the original plan text for the final shipped behavior. |
| [docs/assets/archive/plans/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md](../archive/plans/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md) | Historical phase-6 plan updated with a divergence note pointing back to the living design for the final flag and wizard model. |
| [docs/assets/archive/work/2026-04-16-w5-r2-cli-skill-installation/00-index.md](../archive/work/2026-04-16-w5-r2-cli-skill-installation/00-index.md) | Backlog index updated with a divergence note to clarify that the wave’s shipped behavior differs from several mid-implementation assumptions. |
| [docs/assets/archive/work/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md](../archive/work/2026-04-16-w5-r2-cli-skill-installation/06-wizard-and-cli-flags.md) | Historical phase-6 backlog updated with a divergence note for the final canonical/alias flag split and the completed non-interactive skill controls. |
