...
| --- | --- | --- | --- |
| Instruction-file ownership design | design doc | `docs/assets/archive/designs/2026-06-18-agent-instruction-file-ownership.md` | high |
...
- Plan directory: `docs/assets/archive/plans/2026-06-18-w17-r0-agent-instruction-file-ownership/`
  (this directory).
...
- Baseline docs to annotate: `07`, `13` (and `05`, `06` if implementation
  confirms impact).
- Delta backlog: `docs/assets/archive/work/2026-06-18-w17-r0-agent-instruction-file-ownership/`.
