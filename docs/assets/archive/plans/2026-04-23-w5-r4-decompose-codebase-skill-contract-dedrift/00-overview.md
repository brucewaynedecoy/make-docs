...
| ----- | ------ | -------- | ---------- |
| Originating design | Markdown design doc | `docs/assets/archive/designs/2026-04-23-decompose-codebase-skill-contract-dedrift.md` | High |
| Skill-delivery lineage | Markdown designs, plans, work, history | `docs/designs/2026-04-16-cli-skill-installation*.md`, `docs/assets/archive/designs/2026-04-21-cli-skills-command.md`, `docs/plans/2026-04-16-w5-r*/`, `docs/work/2026-04-16-w5-r*/`, `docs/assets/history/2026-04-16-w5-r*-*.md`, `docs/assets/history/2026-04-17-w5-r3-p1-cli-skill-installation.md` | High |
| Validator lineage | Markdown design, plan, work, history | `docs/assets/archive/designs/2026-04-16-validator-false-positive-links.md`, `docs/assets/archive/plans/2026-04-16-w6-r0-validator-false-positive-links/`, `docs/assets/archive/work/2026-04-16-w6-r0-validator-false-positive-links/`, `docs/assets/history/2026-04-16-w6-r0-*.md` | High |
...
- Plan directory: `docs/assets/archive/plans/2026-04-23-w5-r4-decompose-codebase-skill-contract-dedrift/`
  - entry point: `docs/assets/archive/plans/2026-04-23-w5-r4-decompose-codebase-skill-contract-dedrift/00-overview.md`
  - phase files: `docs/assets/archive/plans/2026-04-23-w5-r4-decompose-codebase-skill-contract-dedrift/0N-<phase>.md`
- New PRD change docs: none
- Baseline docs to annotate: none in `docs/prd/`
- Expected follow-on backlog directory after plan approval: `docs/assets/archive/work/2026-04-23-w5-r4-decompose-codebase-skill-contract-dedrift/`
