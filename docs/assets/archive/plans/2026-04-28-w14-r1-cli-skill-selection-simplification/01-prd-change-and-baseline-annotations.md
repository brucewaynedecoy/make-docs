...
| --- | --- | --- | --- |
| `12` | Current | [historical design](../../designs/2026-04-28-cli-skill-selection-simplification.md) (retired action-PRD: `docs/prd/12-revise-cli-skill-selection-simplification.md`) | Revision making shipped skills one recommended, selected-by-default set instead of required/default plus optional categories. |
...
- Superseded by [historical design](../../designs/2026-04-28-cli-skill-selection-simplification.md) (retired action-PRD: `docs/prd/12-revise-cli-skill-selection-simplification.md`).
```
