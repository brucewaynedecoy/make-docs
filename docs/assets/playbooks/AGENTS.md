...
- When a playbook touches deferred obligations or naive UAT, also read `.make-docs/system/contracts/deferred-obligation-contract.md` and `.make-docs/system/contracts/naive-uat-contract.md`, and treat any shipped naive-UAT playbooks as temporary compatibility seams rather than permission to expand the legacy Playbook runtime.
