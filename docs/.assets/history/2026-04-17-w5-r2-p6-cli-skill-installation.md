...
| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-starter-docs.md](../../guides/user/getting-started-installing-starter-docs.md) | Install guide updated to document the current harness-first wizard, canonical CLI flags, skill scope, and optional-skill selection workflow. |
