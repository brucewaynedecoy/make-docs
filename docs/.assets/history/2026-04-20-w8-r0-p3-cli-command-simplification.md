...
| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-starter-docs.md](../../guides/user/getting-started-installing-starter-docs.md) | Reworked install, sync, reconfigure, command reference, flag matrix, and troubleshooting sections around the new command model. |
