...
| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-make-docs.md](../../guides/user/getting-started-installing-make-docs.md) | Updated manifest, directory tree, conflict staging, and troubleshooting references for the new `.assets/make-docs` state path. |
