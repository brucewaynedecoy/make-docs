...
- Superseded by [15-revise-agent-instruction-file-ownership.md](./15-revise-agent-instruction-file-ownership.md) for root instruction rendering. Root `AGENTS.md` and `CLAUDE.md` are now rendered as delimited managed blocks, while full harness-specific routing is shipped in dedicated `.make-docs/AGENTS.md` and `.make-docs/CLAUDE.md` files.
...
- Superseded by [11-revise-cli-asset-selection-simplification.md](./11-revise-cli-asset-selection-simplification.md) for mode-sensitive prompt/template/reference selection. The effective W14 requirement is that included prompts, templates, and references are invariant managed assets, while the old selection controls are removed rather than normalized.
- Superseded by [15-revise-agent-instruction-file-ownership.md](./15-revise-agent-instruction-file-ownership.md) for generated instruction assets. The template package now includes dedicated `.make-docs/` instruction files as managed assets, and root instruction files are reconciled by managed block rather than whole-file overwrite/skip semantics.
...
- When adding or renaming any template-owned asset, the minimum update set spans `packages/docs/template/`, `packages/cli/src/rules.ts`, `packages/cli/src/catalog.ts`, `packages/cli/src/renderers.ts` when the asset is buildable, the consistency/renderers tests, the packaging sync path in `scripts/copy-template-to-cli.mjs:24-27`, and the manual re-seed guidance in `packages/docs/README.md`. The design and history docs in `docs/assets/archive/designs/2026-04-16-asset-pipeline-completeness.md` and `docs/assets/archive/designs/2026-04-22-docs-assets-resource-namespace.md` show how easy it is for those layers to drift when only one is updated.
- Factual drift note: several historical design and plan docs such as `docs/assets/archive/designs/2026-04-16-asset-pipeline-completeness.md` and `docs/assets/archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md` still describe older hidden namespaces like `docs/.references` or `docs/.assets`. They are useful lineage for why the current system exists, but rebuilders should treat current code plus `packages/docs/template/docs/assets/**` as authoritative.
...
- `docs/assets/archive/designs/2026-04-16-asset-pipeline-completeness.md`
- `docs/assets/archive/designs/2026-04-22-docs-assets-resource-namespace.md`
- `docs/assets/archive/plans/2026-04-16-w4-r0-asset-pipeline-completeness/00-overview.md`
- `docs/assets/archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/02-template-assets-and-renderers.md`
- `docs/assets/archive/plans/2026-04-21-w10-r0-make-docs-rename/02-template-renderers-and-assets.md`
