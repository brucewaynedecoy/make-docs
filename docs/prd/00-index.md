...
PRDs 20, 43, and 44 were retired from the active set by [W19 R6 P3](../designs/2026-09-14-static-harness-adapters-and-conformance-retirement.md). Git history remains the record of their former dynamic conformance, tuple-registry, scenario-kit, and lab-session contracts. Current harness support uses source-owned static adapters plus direct package, release, and installed-product checks under PRDs 10, 16, 28, 30, 36, 39, 48, and 50. PRDs 07, 24, 25, and 38 keep their existing setup, project-intent, Store-access, receipt, and recovery ownership.
...
The current [W19 R5 design](../designs/2026-09-09-first-party-skills-and-managed-adoption.md), [plan](../plans/2026-09-09-w19-r5-first-party-skills-and-managed-adoption/00-overview.md), and [one-phase backlog](../work/2026-09-09-w19-r5-first-party-skills-and-managed-adoption/00-index.md) are complete and owner-accepted on 2026-09-09. W19 R5 is closed and D-005 is resolved. The corrected CLI installs Skills in standard agent locations; the retired private layer was removed through the reviewed public CLI. The owner requested the implementation commit; prior wrong-layout proof remains superseded. W20 and W21 remain paused; W20 P1/P2 remain accepted and P3 has not started.
...
| `17` | [System Asset Materialization and Local Bootstrap](17-system-asset-materialization-and-local-bootstrap.md) | subsystem | Current | 05, 06, 18, 21, 24, 25, 28 | Stable resource identity, provider and provenance resolution, always-local router bootstrap, optional resource bodies, and materialization. |
| `18` | [Compatibility Classification and Migration Safety](18-compatibility-classification-and-migration-safety.md) | subsystem | Current | 05, 15-17, 21, 25, 28, 30, 34-39, 48 | Existing-install classification, Store-first write controls, verified legacy transfer, backup file copies, scoped recovery, and safe failure. |
| `21` | [Project Tool Directory and Resource Tiers](21-project-tool-directory-and-resource-tiers.md) | subsystem | Current | 06, 17, 18, 22, 24, 25, 28, 38, 48 | Peer system resource tiers, the always-local `.make-docs/system/**` router skeleton, optional resource bodies, and the local-content versus Store-state boundary. |
...
| `51` | [Backlog Review and Reporting](51-backlog-review-and-reporting.md) | capability | Current | 08, 14, 23, 25, 39, 49, 50 | Store-free backlog snapshots, deterministic and agentic review twins, concise chat reports, and optional self-contained interactive HTML reports. |

## Source Anchors

- [Store state design](../designs/2026-09-09-store-owned-installation-and-migration-state.md)
- [W19 R3 interrupt plan](../plans/2026-09-09-w19-r3-store-owned-installation-and-migration-state/00-overview.md)
...
- [PRD Authority Maintenance](../../.make-docs/system/references/prd-change-management.md)
- [Output Contract](../../.make-docs/system/contracts/output-contract.md)
- [Lifecycle Anchor](../../.make-docs/system/references/lifecycle.md)
...
Read 01-10, then 16-18, 21-25, 28, 30, 34-39, and 45-47. Treat package, dogfood, migration, static harness support, Store cleanup, paired UAT/Persona behavior, and deferred obligations as explicit acceptance boundaries.
