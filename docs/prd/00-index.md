...
3. Read [11 Revise CLI Asset Selection Simplification](11-revise-cli-asset-selection-simplification.md), [12 Revise CLI Skill Selection Simplification](12-revise-cli-skill-selection-simplification.md), and [13 Revise CLI Conflict Resolution](13-revise-cli-conflict-resolution.md) after the baseline subsystem docs. They carry the active W14 revisions for invariant prompt/template/reference assets, the selected-by-default skill model, and batch-first managed-file conflict review.
...
| `15` | Current | [15-revise-agent-instruction-file-ownership.md](15-revise-agent-instruction-file-ownership.md) | Revision: replaces whole-file overwrite/skip ownership of agent instruction files with a delimited managed-block plus dedicated-file model that preserves user and project-specific content. |
