...
| `21` | [Project Tool Directory and Resource Tiers](21-project-tool-directory-and-resource-tiers.md) | subsystem | Current | 06, 17, 18, 22, 24, 25, 28, 38, 48 | Peer system resource tiers, the always-local `.make-docs/system/**` router skeleton, optional resource bodies, runtime state, and project boundaries. |
