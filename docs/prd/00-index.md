...
- Generate or reconcile the paired delta backlog under `docs/work/2026-06-27-w17-r3-shared-agentics-native-harness-exposure-correction/` before correcting shared agentics native harness exposure, symlink/copy-mirror fallback, or legacy stub migration behavior.
