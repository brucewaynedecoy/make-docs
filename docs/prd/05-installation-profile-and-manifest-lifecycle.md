...
- Superseded by [15-revise-agent-instruction-file-ownership.md](./15-revise-agent-instruction-file-ownership.md) for root agent instruction files, which now use block-scoped ownership, preserve project-owned text outside the block, and delegate full make-docs routing to dedicated `.make-docs/AGENTS.md` and `.make-docs/CLAUDE.md` files.
...
- Superseded by [15-revise-agent-instruction-file-ownership.md](./15-revise-agent-instruction-file-ownership.md) for manifest hashing of root agent instruction files. Manifest entries for `AGENTS.md` and `CLAUDE.md` now hash the managed block body rather than whole-file content, while `.make-docs/AGENTS.md` and `.make-docs/CLAUDE.md` remain whole-file managed assets.
