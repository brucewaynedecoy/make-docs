...
| `bash scripts/check-instruction-routers.sh` | Router integrity | Enforces `AGENTS.md`/`CLAUDE.md` pairing where each `CLAUDE.md` is the one-line `@AGENTS.md` import, per-directory line budgets, and banned headings. | `scripts/check-instruction-routers.sh:34-69`, `packages/cli/src/README.md:165-176` |
