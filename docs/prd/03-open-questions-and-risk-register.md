...
**Recommendation**: Use generated harness stubs as the default cross-platform redirection model; treat symlinks as a later optional optimization only if manifest, audit, fallback, and platform behavior are specified.
