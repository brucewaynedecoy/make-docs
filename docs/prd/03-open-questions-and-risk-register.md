...
**To close**: Closed for structural configurability by PRD 23 and PRD 24; implementation remains open for the config schema, loader, diagnostics, rendering tests, and metadata validators.
