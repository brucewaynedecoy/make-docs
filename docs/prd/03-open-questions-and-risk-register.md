...
**Recommendation**: Author at current paths until a planned phase moves them, record each item's W9 R4 target location, reuse W9 R3 package proof as baseline evidence, and treat remaining relocation as one migration-lab-backed sweep during the restructure.

**To close**: W9 R4 implementation relocates or classifies the remaining surfaces, proves template/package/dogfood parity, and leaves no broken links.
