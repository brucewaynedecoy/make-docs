...
- `docs/work/2026-05-06-w14-r2-cli-conflict-resolution/`
...
4. Generate `docs/work/2026-05-06-w14-r2-cli-conflict-resolution/` from this plan after the plan is accepted for backlog generation.
