...
- Mixed directories such as `docs/assets/history/` and `docs/assets/archive/` are directory-contract surfaces; routers and starter structure may be template-owned, but local records are not automatically shipped starter content.
