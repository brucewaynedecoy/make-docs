...
- The impacted baseline: [PRD 33](../../prd/33-enhance-playbook-packaging-and-harness-adapter-registry.md), plus [PRD 34](../../prd/34-revise-playbook-contract-and-model.md), [PRD 35](../../prd/35-revise-run-playbook-state-machine.md), [PRD 28](../../prd/28-revise-shared-agentics-installation-harness-redirection.md), [PRD 30](../../prd/30-revise-harness-plugin-substrate-workflow-bundles.md), and [PRD 20](../../prd/20-revise-agent-harness-model-conformance-lab.md) as consumed-unchanged constraints.
