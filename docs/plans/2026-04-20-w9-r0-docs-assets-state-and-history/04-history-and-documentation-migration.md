...
| `docs/designs/2026-04-16-archive-docs-skill.md` and active archive-skill plan docs if still used as current references | Update only if they are treated as active source-of-truth for the archive skill behavior. |
