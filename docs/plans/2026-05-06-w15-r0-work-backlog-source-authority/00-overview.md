...
- Coordinate: `W15 R0`
- Artifact path: `docs/plans/2026-05-06-w15-r0-work-backlog-source-authority/`
...
- Expected work output: `docs/work/2026-05-06-w15-r0-work-backlog-source-authority/`.
...
- Execution contract: [execution-workflow.md](../../assets/references/execution-workflow.md)
- Output contract: [output-contract.md](../../assets/references/output-contract.md)
- Work router: [docs/work/AGENTS.md](../../work/AGENTS.md)
- Work templates: [work-index.md](../../assets/templates/work-index.md), [work-phase.md](../../assets/templates/work-phase.md)
...
| Worker 4 | Tests, backlog, and validation | `packages/cli/tests/`, `packages/skills/decompose-codebase/scripts/`, `docs/work/2026-05-06-w15-r0-work-backlog-source-authority/` | Workers 1-3 | focused tests or validator updates, delta backlog, validation evidence |
