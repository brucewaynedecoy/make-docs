...
| Comparison Playbooks CLI | External Rust workspace, read-only | `<user-home>/Developer/Source/Lemme/playbooks` | High — establishes the duplication that motivates the reversal |
