...
- [PRD 28](../../prd/28-shared-agentics-installation-and-harness-exposure.md) defines shared selected-agentics storage and native harness exposure. [PRD 30](../../prd/30-plugin-substrate-and-workflow-bundles.md) (historical section: `playbook-boundary`) defines playbook content and the generic Run Playbook model. This plan connects those contracts to plugin substrate and workflow bundle requirements.
