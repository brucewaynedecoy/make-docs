...
Create [PRD 30](../../prd/30-revise-harness-plugin-substrate-workflow-bundles.md) as the active owner of the v2 plugin substrate, generated harness exposure requirements, and workflow bundle metadata boundary.
...
- PRD 10 must add package proof expectations for plugin payload inclusion or exclusion, no-default plugin behavior, generated exposure files, and support-claim evidence.
...
- PRD 18 must include plugin payloads and generated exposures in compatibility classification and migration dispositions.
...
- PRD 28 must delegate full plugin substrate requirements to PRD 30 while retaining the shared store and generated exposure primitive.
- PRD 29 must cite PRD 30 as the plugin substrate owner while keeping playbook validity independent of plugins.

## Risk Register Updates

- Q-012 remains open for implementation proof, but PRD 30 supplies the substrate-level answer: selected plugins use `.make-docs/agentics/plugins/<plugin-id>/`, generated harness exposure, and config after canonical resolution.
...
- R-014 remains open because plugins, bundles, stubs, skills, and MCP tools must not cite deterministic behavior before CLI/shared-core operations exist.
