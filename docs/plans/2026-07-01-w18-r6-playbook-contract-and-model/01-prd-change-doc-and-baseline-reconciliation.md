...
- Every annotation uses an approved verb and links to `34-revise-playbook-contract-and-model.md`, and the effective requirement is reachable by following links from each annotated baseline heading.
