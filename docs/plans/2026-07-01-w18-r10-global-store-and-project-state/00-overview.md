...
| PRD 35 Revise Run Playbook State Machine | change PRD | [../../prd/35-revise-run-playbook-state-machine.md](../../prd/35-revise-run-playbook-state-machine.md) | High — the run-state facet's owner and this store's first consumer; it cites the Runtime and Global Store lineage as planned W18 R10, which this plan resolves |
| PRD 17 Revise System Asset Materialization Contract | baseline PRD | [../../prd/17-revise-system-asset-materialization-contract.md](../../prd/17-revise-system-asset-materialization-contract.md) | High — the pinned global asset cache and non-optional local bootstrap are preserved and must stay distinct from the operational store |
| PRD 24 Revise Configuration Convention Overlay | baseline PRD | [../../prd/24-revise-configuration-convention-overlay.md](../../prd/24-revise-configuration-convention-overlay.md) | High — project `.make-docs/config.yaml` is preserved unchanged; the machine-level global config is a separate surface that must not override it |
| PRD 32 Revise Lifecycle Backup State Agentics Pruning | baseline PRD | [../../prd/32-revise-lifecycle-backup-state-agentics-pruning.md](../../prd/32-revise-lifecycle-backup-state-agentics-pruning.md) | Medium — repo-level backup and pruning rules are unchanged, but tool uninstall and project setup remove gain global-store handling obligations |
...
- Baseline docs to annotate: `docs/prd/21-revise-tool-directory-system-custom-resource-tiers.md`, `docs/prd/05-installation-profile-and-manifest-lifecycle.md`, `docs/prd/17-revise-system-asset-materialization-contract.md`, `docs/prd/24-revise-configuration-convention-overlay.md`, `docs/prd/32-revise-lifecycle-backup-state-agentics-pruning.md`, `docs/prd/35-revise-run-playbook-state-machine.md`
...
| ------- | ---- | ------------- | ---------------------- |
| [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) | revision | Supersedes the in-repo runtime-state placement of run-state and work-execution evidence under `.make-docs/runs/**` and the per-repo checkpoint JSON with the machine-level global store at `~/.make-docs/`, its SQLite operational database, the manifest-minted stable project identity, and the unified project-state model. | PRD 21, PRD 05, PRD 17, PRD 24, PRD 32, PRD 35, plus the PRD index and risk register. |

## Baseline Annotation Plan

| Baseline doc | Impacted sections | Note verb | Target change doc |
| ------------ | ----------------- | --------- | ----------------- |
| [21-revise-tool-directory-system-custom-resource-tiers.md](../../prd/21-revise-tool-directory-system-custom-resource-tiers.md) | Effective Requirement, runtime-state family (existing `### Change Notes` block, newest note last) | Superseded by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
| [05-installation-profile-and-manifest-lifecycle.md](../../prd/05-installation-profile-and-manifest-lifecycle.md) | Contracts and Data `### Change Notes`, newest note last | Enhanced by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
| [17-revise-system-asset-materialization-contract.md](../../prd/17-revise-system-asset-materialization-contract.md) | Effective Requirement, system asset boundary | Enhanced by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
| [24-revise-configuration-convention-overlay.md](../../prd/24-revise-configuration-convention-overlay.md) | Doc-level Change Notes (W18 R10 paragraph, newest last) | Enhanced by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
| [32-revise-lifecycle-backup-state-agentics-pruning.md](../../prd/32-revise-lifecycle-backup-state-agentics-pruning.md) | Doc-level Change Notes (W18 R10 paragraph, newest last) | Enhanced by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
| [35-revise-run-playbook-state-machine.md](../../prd/35-revise-run-playbook-state-machine.md) | Impacted Docs and Dependencies, cross-design sequencing dependency | Enhanced by | [38-revise-global-store-and-project-state.md](../../prd/38-revise-global-store-and-project-state.md) |
...
| ------ | ----- | ----------- | ------------ | ------------ |
| Change doc author | Author PRD 38 from the revision template with the design's R-* requirement IDs | `docs/prd/38-revise-global-store-and-project-state.md` | Accepted W18 R10 design | The effective-requirement change doc. |
