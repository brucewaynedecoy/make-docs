...
| ----- | ------ | -------- | ---------- |
| Originating design | Markdown design doc | `docs/designs/2026-04-22-docs-assets-resource-namespace.md` | High |
| Prior Wave 9 design | Markdown design doc | `docs/designs/2026-04-20-docs-assets-state-and-history.md` | High |
| Prior Wave 9 plan/work/history | Markdown plan, backlog, history records | `docs/plans/2026-04-20-w9-r0-docs-assets-state-and-history/`, `docs/work/2026-04-20-w9-r0-docs-assets-state-and-history/`, `docs/.assets/history/2026-04-20-w9-r0-*.md` | High |
...
- Plan directory: `docs/plans/2026-04-22-w9-r1-docs-assets-resource-namespace/`
  - entry point: `docs/plans/2026-04-22-w9-r1-docs-assets-resource-namespace/00-overview.md`
  - phase files: `docs/plans/2026-04-22-w9-r1-docs-assets-resource-namespace/0N-<phase>.md`
- New PRD change docs: none
- Baseline docs to annotate: none in `docs/prd/`
- Expected follow-on backlog directory after plan approval: `docs/work/2026-04-22-w9-r1-docs-assets-resource-namespace/`
