...
| File | Change Summary |
| ---- | -------------- |
| `docs/work/2026-04-23-w13-r0-documentation-coverage-and-guide-orchestration/supporting/capability-coverage-ledger.md` | Resolve provisional coverage fields into final documentation actions. |
| `docs/work/2026-04-23-w13-r0-documentation-coverage-and-guide-orchestration/supporting/guide-delivery-map.md` | Create the execution-facing map of guide families, target files, priorities, and worker assignments. |
