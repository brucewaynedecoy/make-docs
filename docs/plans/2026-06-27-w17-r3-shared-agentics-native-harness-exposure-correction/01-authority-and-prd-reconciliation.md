...
- Reconcile [PRD 28](../../prd/28-revise-shared-agentics-installation-harness-redirection.md) in place so it names symlink-first native harness exposure and managed copy-mirror fallback as the target.
