...
The design's coordinate handoff is unresolved. This plan uses `W9 R3` because the design is part of Batch 2 canonical information architecture and materially revises the earlier W9 docs-assets namespace after [W9 R2 Tool Directory System and Custom Resource Tiers](../2026-06-23-w9-r2-tool-directory-system-custom-resource-tiers/00-overview.md) reserved `.make-docs/**` for tool resources. It also records W16 `docs/library/playbooks/**` as transitional, but the dominant lineage is the W9 docs-assets restructure.
...
- Active guide routing and installed assets still reference `docs/guides/**`.
- W16 introduced `docs/library/playbooks/agent/make-docs-lifecycle.md` as a temporary playbook home.
