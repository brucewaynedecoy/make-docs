...
- For guides, continue in `docs/guides/`. Before writing, read `docs/assets/references/guide-contract.md` and `docs/assets/references/coverage-pass-contract.md`, inspect existing guides for overlap, use the coverage-pass contract to choose the guide/playbook verdict and target persona(s), and use the matching template (`docs/assets/templates/guide-developer.md` or `docs/assets/templates/guide-user.md`).
