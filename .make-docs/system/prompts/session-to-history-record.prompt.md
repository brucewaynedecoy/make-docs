...
Before writing anything, read `.make-docs/system/contracts/history-record-contract.md`, `.make-docs/system/contracts/coverage-pass-contract.md`, `.make-docs/system/templates/history-record.md`, and the router at `docs/assets/archive/AGENTS.md` (or `CLAUDE.md`). Do not restate their rules — follow them.
