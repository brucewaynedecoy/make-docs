...
Author system resources only in these physical upstream package roots:

| Type | Upstream source root |
| --- | --- |
| `contract` | `packages/docs/template/.make-docs/system/contracts/` |
| `prompt` | `packages/docs/template/.make-docs/system/prompts/` |
| `reference` | `packages/docs/template/.make-docs/system/references/` |
| `template` | `packages/docs/template/.make-docs/system/templates/` |

The catalog at `packages/docs/template/.make-docs/system-resources.catalog.json` is the one upstream inventory. Its schema is `packages/docs/template/.make-docs/system-resources.schema.json`. These physical paths are maintainer authoring authority. Provider-backed consumers do not depend on them.
