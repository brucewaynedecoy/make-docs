...
| --- | --- |
| `contract` | `packages/docs/template/.make-docs/contracts/system/` |
| `prompt` | `packages/docs/template/.make-docs/prompts/system/` |
| `reference` | `packages/docs/template/.make-docs/references/system/` |
| `template` | `packages/docs/template/.make-docs/templates/system/` |
