...
- Use `.make-docs/templates/system/` for reusable document skeletons.
- Do not write generated project documentation here.
- Do not add project-local contract overrides here; use `.make-docs/contracts/custom/` when custom overlays are implemented.
<!-- make-docs:end -->
