...
| File | Change Summary |
| ---- | -------------- |
| `docs/assets/archive/work/2026-04-23-w13-r0-documentation-coverage-and-guide-orchestration/supporting/capability-coverage-ledger.md` | Create the canonical ledger with one normalized row per current-state capability or documentation-worthy surface. |
