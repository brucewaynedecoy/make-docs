...
> Implemented divergence: the shipped CLI does not publish a staged skill directory. Prepack validates and publishes registry metadata only, while skills are resolved remotely at install time. See the [updated design](../../designs/2026-04-16-cli-skill-installation-r2.md) and phase-5 agent guide (historical path: `../../guides/agent/2026-04-17-w5-r2-p5-cli-skill-installation.md`).
