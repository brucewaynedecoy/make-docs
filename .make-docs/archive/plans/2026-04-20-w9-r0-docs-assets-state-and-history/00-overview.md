...
| ----- | ------ | -------- | ---------- |
| Approved design | Markdown design doc | `docs/assets/archive/designs/2026-04-20-docs-assets-state-and-history.md` | High |
...
- Plan directory: `docs/assets/archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/`
- Entry point: `docs/assets/archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/00-overview.md`
- Phase files: `docs/assets/archive/plans/2026-04-20-w9-r0-docs-assets-state-and-history/0N-<phase>.md`
- Expected follow-on backlog directory after plan approval: `docs/assets/archive/work/2026-04-20-w9-r0-docs-assets-state-and-history/`
- New PRD docs: none
