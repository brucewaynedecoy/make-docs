...
| ----- | ------ | -------- | ---------- |
| Approved design | Markdown design doc | `docs/assets/archive/designs/2026-04-21-make-docs-rename.md` | High |
...
- Plan directory: `docs/assets/archive/plans/2026-04-21-w10-r0-make-docs-rename/`
- Entry point: `docs/assets/archive/plans/2026-04-21-w10-r0-make-docs-rename/00-overview.md`
- Phase files: `docs/assets/archive/plans/2026-04-21-w10-r0-make-docs-rename/0N-<phase>.md`
- Expected follow-on backlog directory: `docs/assets/archive/work/2026-04-21-w10-r0-make-docs-rename/`
- New PRD docs: none
