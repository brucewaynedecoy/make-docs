...
This playbook is the agent persona's map for working through the make-docs lifecycle. It is not automation, does not enforce stage order, and does not gate work. Use the lifecycle anchor for ordering defaults: [lifecycle.md](../../../system/references/lifecycle.md).
...
- [coverage-pass-contract.md](../../../system/contracts/coverage-pass-contract.md)
