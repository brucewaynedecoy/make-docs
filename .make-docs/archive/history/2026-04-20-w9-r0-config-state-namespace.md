...
| [docs/.references/commit-message-convention.md](../../system/contracts/commit-message-convention.md) | Updated the Wave 9 commit-message example to name the config namespace. |
...
| Path | Description |
| --- | --- |
| [docs/guides/developer/cli-development-local-build-and-install.md](../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | Updated smoke-pack guidance to assert the config manifest path. |

### User

| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-make-docs.md](../../../docs/assets/user/getting-started-installing-make-docs.md) | Updated manifest, conflict staging, directory tree, and troubleshooting references to `docs/.assets/config/`. |
