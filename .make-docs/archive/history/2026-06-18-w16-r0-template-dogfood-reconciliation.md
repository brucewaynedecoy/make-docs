...
| Path | Description |
| --- | --- |
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Added D-014 recording the dogfood-vs-template layering drift and its resolution. |
