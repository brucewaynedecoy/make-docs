...
| Path | Description |
| --- | --- |
| [../../../../.make-docs/contracts/system/commit-message-convention.md](../../system/contracts/commit-message-convention.md) | Requires full subject-plus-body commit-message drafts and documents fallback body generation from the actual diff. |
