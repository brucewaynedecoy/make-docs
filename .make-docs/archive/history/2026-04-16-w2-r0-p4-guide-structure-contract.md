...
| Path | Description |
| --- | --- |
| [docs/assets/archive/work/2026-04-16-w2-r0-guide-structure-contract/04-migration-and-reseed.md](../work/2026-04-16-w2-r0-guide-structure-contract/04-migration-and-reseed.md) | Work backlog phase — acceptance criteria checked off. |

### Developer

| Path | Description |
| --- | --- |
| [docs/guides/developer/cli-development-local-build-and-install.md](../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | Migrated: renamed and added YAML frontmatter. |

### User

| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-make-docs.md](../../../docs/assets/user/getting-started-installing-make-docs.md) | Migrated: renamed and added YAML frontmatter. |
