...
- PRD coverage: updated [03 Open Questions and Risk Register](../../../docs/prd/03-open-questions-and-risk-register.md) in place. No new PRD change doc was needed because [historical closeout](2026-06-25-w16-r1-p4-package-parity-and-closeout.md) (retired action-PRD: `docs/prd/23-revise-generated-metadata-lifecycle-handoffs.md`) already owns the effective generated metadata and lifecycle handoff requirements.
...
| Path | Description |
| --- | --- |
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Narrowed `Q-011`, `R-004`, `R-011`, `R-013`, and `R-014` around PRD 23 generated metadata, configuration, validation, no-scripts, and backfill boundaries. |
| [docs/work/2026-06-23-w16-r1-generated-metadata-lifecycle-handoffs/01-requirements-and-register-reconciliation.md](../../../docs/work/2026-06-23-w16-r1-generated-metadata-lifecycle-handoffs/01-requirements-and-register-reconciliation.md) | Marked Phase 1 complete and recorded PRD/register evidence and coverage decisions. |
