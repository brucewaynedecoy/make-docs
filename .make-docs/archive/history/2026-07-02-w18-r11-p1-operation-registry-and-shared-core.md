...
| Path | Description |
| --- | --- |
| [../../../work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/01-operation-registry-and-shared-core.md](../../../docs/work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/01-operation-registry-and-shared-core.md) | Marked Phase 1 tasks t1 through t7 complete. |
| [../../../prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Advanced R-016 (pending progression identifiers ahead of the W18 R7 engine) and R-024 (registry/core landed, no hand-wired retained operations, `playbook.validate` surface guard) in place. |

### Developer

| Path | Description |
| --- | --- |
| [../../library/developer/cli-mcp-operation-parity-and-permissions.md](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) | Reframed the parity contract around the operation registry: registration rules, per-operation modules, uniform context gating, mechanical dependency-direction checks, and the registered identifier table. |
