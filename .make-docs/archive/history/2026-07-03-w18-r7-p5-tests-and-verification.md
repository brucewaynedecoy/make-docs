...
| Path | Description |
| --- | --- |
| [../../../prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Advanced R-016 in place with the W18 R7 P5 D10 verification evidence and wave completion at 775/775, leaving plugin-surface parity as the single remaining close input. |
...
| Path | Description |
| --- | --- |
| [../../library/user/playbooks-running-make-docs-workflows.md](../legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) | Retired the "planned product behavior" hedge now the run lifecycle is implemented and verified, and resolved the wave-triggered Future Coverage bullet with a no-projection-guide decision. |
