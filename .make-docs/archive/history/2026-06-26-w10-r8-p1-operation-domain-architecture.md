...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/cli-mcp-operation-parity-and-permissions.md](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) | Updated the existing CLI/MCP operation parity guide with TypeScript-owned operation-domain guidance and W10 R7 Rust-shelving language. |
