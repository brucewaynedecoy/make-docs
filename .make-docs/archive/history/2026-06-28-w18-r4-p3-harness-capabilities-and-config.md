...
| Path | Description |
| --- | --- |
| [docs/work/2026-06-27-w18-r4-run-playbook-orchestration-and-harness-capabilities/03-harness-capabilities-and-config.md](../../../docs/work/2026-06-27-w18-r4-run-playbook-orchestration-and-harness-capabilities/03-harness-capabilities-and-config.md) | Marked Phase 3 harness capability and config tasks complete. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/playbooks-development-runner-architecture.md](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) | Updated with harness capability config and evaluation behavior. |
