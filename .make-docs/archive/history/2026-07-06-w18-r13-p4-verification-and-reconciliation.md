...
| Path | Description |
| --- | --- |
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | D-023, D-024, and R-028 closed with resolutions citing the verification and reconciliation evidence; R-021 and R-022 advanced in place (stay open on the operated-session input); Q-022 confirmed. No renumbering. |
| [docs/work/2026-07-06-w18-r13-conformance-execution-and-lab-session-redesign/04-verification-and-reconciliation.md](../../../docs/work/2026-07-06-w18-r13-conformance-execution-and-lab-session-redesign/04-verification-and-reconciliation.md) | All nine phase tasks checked complete — the wave's final phase. |
| [docs/work/2026-07-01-w18-r9-playbook-and-package-conformance/00-index.md](../../../docs/work/2026-07-01-w18-r9-playbook-and-package-conformance/00-index.md) | Forward W18 R13 reconciliation note added; the R9 phase text and history records stay historical. |

### Developer

| Path | Description |
| --- | --- |
| [docs/assets/library/developer/conformance-lab-scenario-and-result-contracts.md](../../../docs/assets/maintainer/conformance-lab-scenario-and-result-contracts.md) | Rewritten to the new model: the old copy-per-harness adapter table became Execution Targets and Uncovered-Target Reporting, the scenario-spec section distinguishes the unchanged lab core from the packaging `targets` shape, the Phase 1–3 additions are preserved, and the `support-claim-state` marker stays byte-unchanged at 0/20. |
