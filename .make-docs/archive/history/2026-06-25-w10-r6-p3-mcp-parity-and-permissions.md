...
- Developer-guide coverage: created [CLI/MCP Operation Parity and Permissions](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) and linked it from adjacent CLI/package maintainer guides.
...
| Path | Description |
| --- | --- |
| [docs/work/2026-06-23-w10-r6-cli-separation-and-mcp-boundary/03-mcp-parity-and-permissions.md](../../../docs/work/2026-06-23-w10-r6-cli-separation-and-mcp-boundary/03-mcp-parity-and-permissions.md) | Marked Phase 3 tasks complete and recorded MCP parity, permission, fixture, and coverage evidence. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/cli-mcp-operation-parity-and-permissions.md](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) | Added the maintainer contract for future MCP operation mapping, read-first outputs, dry-run planning, permissions, and parity fixtures. |
| [docs/assets/library/developer/cli-development-local-build-and-install.md](../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | Linked maintainers to the new MCP parity guide before Rust or MCP work. |
| [docs/assets/library/developer/release-packaging-validation-and-release-reference.md](../../../docs/assets/maintainer/release-packaging-validation-and-release-reference.md) | Linked package validation guidance to the MCP parity guide so smoke-pack proof is not mistaken for MCP support evidence. |
