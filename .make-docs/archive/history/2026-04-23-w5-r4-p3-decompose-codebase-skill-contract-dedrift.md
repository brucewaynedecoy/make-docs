...
| [docs/assets/templates/work-phase.md](../../system/templates/work-phase.md) | Corrected the shared work-phase PRD link path to the repo's actual backlog-to-PRD relative layout. |
