...
| Path | Description |
| --- | --- |
| [docs/work/2026-06-27-w18-r4-run-playbook-orchestration-and-harness-capabilities/02-resolver-and-stack-disambiguation.md](../../../docs/work/2026-06-27-w18-r4-run-playbook-orchestration-and-harness-capabilities/02-resolver-and-stack-disambiguation.md) | Marked Phase 2 resolver and stack-disambiguation tasks complete. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/playbooks-development-runner-architecture.md](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) | Updated with implemented Playbook catalog and resolver operation names. |
