...
Commit-message drafting used [docs/assets/references/commit-message-convention.md](../../system/contracts/commit-message-convention.md). No W/R/P coordinate applies because this was skill workflow maintenance rather than a single work backlog phase.
