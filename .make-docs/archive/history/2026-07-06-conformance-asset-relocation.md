...
| [PRD index](../../../docs/prd/00-index.md) | Row 42 added; reading order, source anchors, audience paths, and the W18 R9 follow-on line corrected to the new home. |
...
Live docs updated in place: the four claim surfaces ([conformance/README.md](../../../conformance/README.md) — including a new location-rationale paragraph — the [user packaging guide](../legacy-playbooks/library/user/playbooks-packaging-shareable-agent-workflows.md), the [developer packaging guide](../legacy-playbooks/library/developer/playbooks-development-packaging-and-harness-adapters.md), and the [developer conformance-lab guide](../../../docs/assets/maintainer/conformance-lab-scenario-and-result-contracts.md)), the register, the PRD set, and the PRD index. The artifacts lineage doc `docs/assets/artifacts/playbook-architecture.md` names no conformance path (verified; untouched). Dated evidence left historical: the completed [W18 R9 backlog](../../../docs/work/2026-07-01-w18-r9-playbook-and-package-conformance/00-index.md) (which gained a reconciliation usage note per the R12-note pattern), its phase files, the W18 R9 plan and design docs, the W10 R5 plan and lab design, and the four W18 R9 phase history records — whose relative link targets alone were repointed so they resolve from the new location, with their displayed historical text unchanged. Remaining `docs/assets/conformance` mentions in code and this change's own docs are the deliberate old-home detection markers and explicit "relocated from" statements.
...
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | D-022 added Closed with Resolution; R-021/R-022 path mentions updated in place. |
...
| [docs/prd/00-index.md](../../../docs/prd/00-index.md) | PRD 42 catalogued; path mentions corrected. |
| [docs/work/2026-07-01-w18-r9-playbook-and-package-conformance/00-index.md](../../../docs/work/2026-07-01-w18-r9-playbook-and-package-conformance/00-index.md) | Post-wave relocation reconciliation usage note added; phase text preserved as historical. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/conformance-lab-scenario-and-result-contracts.md](../../../docs/assets/maintainer/conformance-lab-scenario-and-result-contracts.md) | Registry, scenario, fixture, result, and layer-home paths updated to `conformance/…`; R-TEST-3 detection description updated to the new marker design. |
| [docs/assets/library/developer/playbooks-development-packaging-and-harness-adapters.md](../legacy-playbooks/library/developer/playbooks-development-packaging-and-harness-adapters.md) | Registry and scenario path mentions updated. |

### User

| Path | Description |
| --- | --- |
| [docs/assets/library/user/playbooks-packaging-shareable-agent-workflows.md](../legacy-playbooks/library/user/playbooks-packaging-shareable-agent-workflows.md) | Conformance-registry link repointed to the repo-root home. |
