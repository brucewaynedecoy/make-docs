...
| Path | Description |
| --- | --- |
| [../../../prd/06-template-contracts-and-generated-assets.md](../../../docs/prd/06-template-contracts-and-generated-assets.md) | Replaces the old dynamic renderer/buildable-asset model with the static template asset contract. |
| [../../../prd/08-skills-catalog-and-distribution.md](../../../docs/prd/08-skills-catalog-and-distribution.md) | Aligns skills delivery with explicit optional selected skills and no default skill files. |
| [historical design](../designs/2026-04-28-cli-skill-selection-simplification.md) (retired action-PRD: `docs/prd/12-revise-cli-skill-selection-simplification.md`) | Revises the selected-skill model so fresh defaults install no skills. |
| [historical design](../designs/2026-06-18-agent-instruction-file-ownership.md) (retired action-PRD: `docs/prd/15-revise-agent-instruction-file-ownership.md`) | Clarifies static template sourcing plus block-scoped instruction reconciliation. |
