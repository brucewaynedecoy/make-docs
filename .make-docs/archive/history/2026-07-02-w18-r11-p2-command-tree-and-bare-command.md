...
| Path | Description |
| --- | --- |
| [../../../work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/02-command-tree-and-bare-command.md](../../../docs/work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/02-command-tree-and-bare-command.md) | Marked Phase 2 tasks t1 through t4 complete. |
| [../../../prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Advanced R-024 (five-command tree landed) and D-002 (public command guidance moved to the new taxonomy) in place. |

### Developer

| Path | Description |
| --- | --- |
| [../../library/developer/playbooks-development-runner-architecture.md](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) | Respelled the runner operation surface to `run playbook ...` and added the MCP-rename Future Coverage bullet. |
| [../../library/developer/playbooks-development-packaging-and-harness-adapters.md](../legacy-playbooks/library/developer/playbooks-development-packaging-and-harness-adapters.md) | Respelled the packaging surface to `run package plan|surface-resolve|write`. |
| [../../library/developer/skills-catalog-and-distribution-model.md](../../../docs/assets/maintainer/skills-catalog-and-distribution-model.md) | Moved skills command mentions to `setup skills`. |
| [../../library/developer/maintainer-docs-assets-and-runtime-state-boundaries.md](../../../docs/assets/maintainer/maintainer-docs-assets-and-runtime-state-boundaries.md) | Rewrote the work-lifecycle bullet around the retained `run work` operations and the pruned cluster's Playbook-rebuild disposition. |
| [../../library/developer/cli-development-local-build-and-install.md](../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | Moved local build/run instructions to `setup` invocations. |

### User

| Path | Description |
| --- | --- |
| [../../library/user/getting-started-installing-make-docs.md](../../../docs/assets/user/getting-started-installing-make-docs.md) | Moved install commands to `setup` and documented the context-aware bare behavior. |
| [../../library/user/cli-lifecycle-managing-installations.md](../../../docs/assets/user/cli-lifecycle-managing-installations.md) | Reworked the command model around the `setup` subtree, renamed uninstall to removal, and updated troubleshooting for the never-syncs bare command. |
| [../../library/user/skills-installing-and-managing-skills.md](../../../docs/assets/user/skills-installing-and-managing-skills.md) | Moved skills management to `setup skills`. |
| [../../library/user/skills-decomposing-an-existing-codebase.md](../../../docs/assets/user/skills-decomposing-an-existing-codebase.md) | Moved skill install commands to `setup skills`. |
| [../../library/user/playbooks-running-make-docs-workflows.md](../legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) | Moved playbook commands to `run playbook ...` and resolved the rename trigger in Future Coverage. |
| [../../library/user/playbooks-packaging-shareable-agent-workflows.md](../legacy-playbooks/library/user/playbooks-packaging-shareable-agent-workflows.md) | Moved packaging commands to `run package ...`. |
