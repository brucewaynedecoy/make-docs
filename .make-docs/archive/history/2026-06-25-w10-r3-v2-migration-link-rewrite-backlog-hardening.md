...
| Path | Description |
| --- | --- |
| [W10 R3 compatibility backlog](../../../docs/work/2026-06-23-w10-r3-compatibility-audit-and-migration-disposition/00-index.md) | Primary backlog owner for packaged migration hardening around documentation-tree move planning, link rewriting, review routing, and validation. |
| [W9 R2 tool-directory backlog](../../../docs/work/2026-06-23-w9-r2-tool-directory-system-custom-resource-tiers/00-index.md) | Added guardrails that classify W9 R2 path work as fixture evidence rather than V2 migration proof. |
| [W9 R5 library/archive-history correction](../../../docs/work/2026-06-25-w9-r5-v2-library-and-archive-history-ia-correction/03-dogfood-migration-and-link-repair.md) | Added guardrails that classify the W9 R5 dogfood migration and changed-file link checks as insufficient for shipped user migration acceptance. |
| [W10 R4 template/package source-of-truth backlog](../../../docs/work/2026-06-23-w10-r4-template-package-dogfood-source-of-truth-contract/00-index.md) | Added package/source-of-truth prerequisites so dogfood cleanup cannot be cited as packaged migration behavior. |
