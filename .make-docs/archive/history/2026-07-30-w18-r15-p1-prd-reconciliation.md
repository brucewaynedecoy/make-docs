...
| Path | Description |
| --- | --- |
| [docs/prd/45-deferred-obligation-governance.md](../../../docs/prd/45-deferred-obligation-governance.md) | New capability authority for durable deferred obligations and anti-orphan governance. |
| [docs/prd/46-naive-end-user-acceptance-testing.md](../../../docs/prd/46-naive-end-user-acceptance-testing.md) | New capability authority for true naive end-user UAT. |
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Added the canonical obligation register and initial migration dispositions. |
| [docs/prd/00-index.md](../../../docs/prd/00-index.md) | Updated active-set navigation, capability-authority policy, and future handoff. |
| [docs/prd/01-product-overview.md](../../../docs/prd/01-product-overview.md) | Added both capabilities to the product-level feature map. |
| [docs/prd/04-glossary.md](../../../docs/prd/04-glossary.md) | Added obligation, UAT, evidence, outcome, and status vocabulary. |
| [W18 R15 plan overview](../../../docs/plans/2026-07-30-w18-r15-deferred-obligations-and-naive-uat-governance/00-overview.md) | Corrected the bundle to use capability-oriented PRD ownership. |
| [W18 R15 Phase 1](../../../docs/plans/2026-07-30-w18-r15-deferred-obligations-and-naive-uat-governance/01-prd-capability-authority-and-baseline-reconciliation.md) | Defines the completed reconciliation scope and conservative migration rules. |
