...
| [../../../CLAUDE.md](../../../docs/CLAUDE.md) | Added the playbook-contract routing bullet (paired with `docs/AGENTS.md` and the upstream template copies). |
| [../../../../.make-docs/contracts/system/CLAUDE.md](../../system/contracts/CLAUDE.md) | Contract-directory router updated for playbook-contract discovery (paired with `AGENTS.md` and the upstream template copies). |
...
| [../../../work/2026-07-01-w18-r6-playbook-contract-and-model/01-playbook-contract-authoring.md](../../../docs/work/2026-07-01-w18-r6-playbook-contract-and-model/01-playbook-contract-authoring.md) | Marked Phase 1 tasks t1 through t8 complete. |
| [../../../prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Updated the R-018 current-state cell to record the Phase 1 contract landing while keeping the item Open for validator/fixture/parity work. |

### Developer

| Path | Description |
| --- | --- |
| [../../library/developer/playbooks-development-runner-architecture.md](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) | Added the Playbook contract authority note to Catalog Contract Validation, related links to PRD 34 and the contract, and a Future Coverage bullet for the W18 R6 parser/validator phases. |

### User

| Path | Description |
| --- | --- |
| [../../library/user/playbooks-running-make-docs-workflows.md](../legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) | Added a Future Coverage bullet persisting the deferred reader-facing contract projection and the filename/validate/catalog refresh blocked on W18 R6 Phases 2 through 5. |
