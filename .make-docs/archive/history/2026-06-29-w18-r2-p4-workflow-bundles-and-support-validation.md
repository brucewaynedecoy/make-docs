...
| Path | Description |
| --- | --- |
| [../../../work/2026-06-23-w18-r2-harness-plugin-substrate-workflow-bundles/04-workflow-bundles-and-support-validation.md](../../../docs/work/2026-06-23-w18-r2-harness-plugin-substrate-workflow-bundles/04-workflow-bundles-and-support-validation.md) | Marked Phase 4 implementation tasks complete and recorded validation evidence. |

### Developer

| Path | Description |
| --- | --- |
| [../../library/developer/plugin-substrate-workflow-bundles-maintainer-contract.md](../legacy-playbooks/library/developer/plugin-substrate-workflow-bundles-maintainer-contract.md) | New draft maintainer guide for workflow bundle metadata, package boundaries, support claims, and conformance candidate validation. |
