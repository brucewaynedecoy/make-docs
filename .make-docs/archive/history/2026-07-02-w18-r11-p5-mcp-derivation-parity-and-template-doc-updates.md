...
Developer- and user-guide coverage was `update-existing`: the [CLI/MCP parity guide](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) now documents the derivation rule, the never-hand-add-an-operation-tool rule, and the parity seam; the [runner architecture guide](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) and [running-playbooks user guide](../legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) moved their quoted tool names to the derived spellings and resolved their MCP-rename Future Coverage triggers; the [CLI lifecycle guide](../../../docs/assets/user/cli-lifecycle-managing-installations.md) cleared its resolved trigger.
...
| Path | Description |
| --- | --- |
| [../../../work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/05-mcp-derivation-parity-and-template-doc-updates.md](../../../docs/work/2026-07-01-w18-r11-cli-command-reorganization-and-operation-registry/05-mcp-derivation-parity-and-template-doc-updates.md) | Marked Phase 5 tasks t1 through t5 complete. |
| [../../../prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Advanced R-024 in place: MCP derivation landed, template consequence a verified no-op, close conditions narrowed to Phase 6. |
...
| Path | Description |
| --- | --- |
| [../../library/developer/cli-mcp-operation-parity-and-permissions.md](../../../docs/assets/maintainer/cli-mcp-operation-parity-and-permissions.md) | Documented the MCP tool derivation rule, parity seam, and never-hand-add rule. |
| [../../library/developer/playbooks-development-runner-architecture.md](../legacy-playbooks/library/developer/playbooks-development-runner-architecture.md) | Moved quoted MCP tool names to the derived spellings and resolved the rename trigger. |

### User

| Path | Description |
| --- | --- |
| [../../library/user/playbooks-running-make-docs-workflows.md](../legacy-playbooks/library/user/playbooks-running-make-docs-workflows.md) | Moved quoted MCP tool names to the derived spellings and resolved the rename trigger. |
| [../../library/user/cli-lifecycle-managing-installations.md](../../../docs/assets/user/cli-lifecycle-managing-installations.md) | Cleared the resolved MCP-rename Future Coverage trigger. |
