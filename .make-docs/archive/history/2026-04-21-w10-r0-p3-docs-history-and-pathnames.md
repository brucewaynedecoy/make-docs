...
| [docs/.references/commit-message-convention.md](../../system/contracts/commit-message-convention.md) | Active reference copy updated for the new product name. |
| [docs/.references/history-record-contract.md](../../system/contracts/history-record-contract.md) | Active history contract copy updated for the new product name. |
...
| Path | Description |
| --- | --- |
| [docs/guides/developer/cli-development-local-build-and-install.md](../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | Developer build and local install guide updated for `make-docs` commands and package paths. |
| [docs/guides/developer/roadmap.md](../../../docs/assets/maintainer/roadmap.md) | Developer roadmap copy updated for the new product name. |

### User

| Path | Description |
| --- | --- |
| [docs/guides/user/getting-started-installing-make-docs.md](../../../docs/assets/user/getting-started-installing-make-docs.md) | Renamed user install guide with updated title, examples, and source-install paths. |
