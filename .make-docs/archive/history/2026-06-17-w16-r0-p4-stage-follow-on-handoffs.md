...
- Updated [planning-workflow.md](../../system/references/planning-workflow.md) and
  [plan-overview.md](../../system/templates/plan-overview.md) so plan `00-overview.md`
  files recommend PRD generation as the next step.
- Updated [output-contract.md](../../system/contracts/output-contract.md) and
  [prd-index.md](../../system/templates/prd-index.md) so PRD indexes recommend
  work-backlog generation as the next step.
- Updated [work-index.md](../../system/templates/work-index.md) so work backlog indexes
