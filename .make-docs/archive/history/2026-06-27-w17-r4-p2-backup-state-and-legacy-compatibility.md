...
| Path | Description |
| --- | --- |
| [docs/work/2026-06-27-w17-r4-lifecycle-backup-state-and-agentics-pruning/02-backup-state-and-legacy-compatibility.md](../../../docs/work/2026-06-27-w17-r4-lifecycle-backup-state-and-agentics-pruning/02-backup-state-and-legacy-compatibility.md) | Marked Phase 2 complete and recorded backup-state validation evidence. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/user/cli-lifecycle-managing-installations.md](../../../docs/assets/user/cli-lifecycle-managing-installations.md) | Updated lifecycle backup guidance for `.make-docs/backup/**` and legacy `.backup/**` recovery evidence. |
