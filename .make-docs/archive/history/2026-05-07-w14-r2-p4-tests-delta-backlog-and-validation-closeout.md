...
| `t16` | Complete | Stale scans found no removed instruction-conflict names in active code/tests, and stale conflict-review wording was fixed in [07 CLI Command Surface and Lifecycle](../../../docs/prd/07-cli-command-surface-and-lifecycle.md) and [the CLI maintainer README](../../../packages/cli/src/README.md). |
...
- No risk-register update was needed. The active PRD wording blocker was already fixed in [07 CLI Command Surface and Lifecycle](../../../docs/prd/07-cli-command-surface-and-lifecycle.md), the stale CLI maintainer README prompt text was corrected during closeout, and no additional risk, drift, or open-question entry was required.
