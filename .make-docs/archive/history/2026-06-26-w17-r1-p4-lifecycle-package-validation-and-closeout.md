...
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Updated Q-001, R-002, and R-006 with concrete W17 R1 evidence while preserving open delivery and lifecycle-removability follow-ups. |
...
| Path | Description |
| --- | --- |
| [docs/assets/library/developer/skills-catalog-and-distribution-model.md](../../../docs/assets/maintainer/skills-catalog-and-distribution-model.md) | Corrected the maintainer guide for purpose-led selected-skill behavior and no-default skill files. |

### User

| Path | Description |
| --- | --- |
| [docs/assets/library/user/skills-installing-and-managing-skills.md](../../../docs/assets/user/skills-installing-and-managing-skills.md) | Corrected user guidance so skills are described as explicitly selected and bare installs remain skill-free. |
