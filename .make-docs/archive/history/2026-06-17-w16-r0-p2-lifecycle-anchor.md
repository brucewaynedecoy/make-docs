...
- Updated [lifecycle.md](../../system/references/lifecycle.md) with the lifecycle arc,
...
- Updated root routers
  [AGENTS.md](../../../docs/AGENTS.md) and [CLAUDE.md](../../../docs/CLAUDE.md) with the
  always-read lifecycle pointer.
- Updated docs routers [AGENTS.md](../../../docs/assets/AGENTS.md) and
  [CLAUDE.md](../../../docs/assets/CLAUDE.md) with the lifecycle pointer.
- Updated references routers [AGENTS.md](../../system/references/AGENTS.md) and
  [CLAUDE.md](../../system/references/CLAUDE.md) with the reference-specific lifecycle
  pointer.
