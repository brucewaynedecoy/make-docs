...
| [docs/prd/03-open-questions-and-risk-register.md](../../../docs/prd/03-open-questions-and-risk-register.md) | Updated no-scripts and skill-refactor risks with W10 R8 Phase 4 release-boundary evidence while leaving broader helper, write, plugin, shared-agentics, and delivery-model work open. |
