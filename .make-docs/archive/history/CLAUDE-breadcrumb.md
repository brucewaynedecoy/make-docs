<!-- make-docs:begin -->
# Breadcrumb Assets Router

This directory stores session breadcrumb records.
...
- When W/R/P is known, create records at `docs/assets/breadcrumbs/YYYY-MM-DD-w{W}-r{R}-p{P}-<slug>.md`.
- If only W/R is known, create records at `docs/assets/breadcrumbs/YYYY-MM-DD-w{W}-r{R}-<slug>.md`.
- If no coordinate is known, create records at `docs/assets/breadcrumbs/YYYY-MM-DD-<slug>.md`.
