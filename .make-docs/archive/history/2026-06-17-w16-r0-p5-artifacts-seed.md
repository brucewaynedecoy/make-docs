...
- Updated [lifecycle.md](../../system/references/lifecycle.md) and
  [planning-workflow.md](../../system/references/planning-workflow.md) to cite
  `docs/artifacts/` as optional input context.
- Updated artifacts routers [AGENTS.md](../../../docs/assets/AGENTS.md) and
  [CLAUDE.md](../../../docs/assets/CLAUDE.md) to state the managed/template asset and
