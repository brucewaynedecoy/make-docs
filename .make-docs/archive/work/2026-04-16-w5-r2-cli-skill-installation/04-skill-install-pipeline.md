...
> Implemented divergence: the shipped installer preserves each skill as a full directory under the harness root and colocates support files inside that directory. There is no `skill-assets/` projection model in the final implementation. See the [updated design](../../designs/2026-04-16-cli-skill-installation-r2.md) and phase-5 agent guide (historical path: `../../guides/agent/2026-04-17-w5-r2-p5-cli-skill-installation.md`).
