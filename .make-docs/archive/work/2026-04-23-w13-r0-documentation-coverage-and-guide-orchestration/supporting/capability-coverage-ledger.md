...
> Phase 1 artifact for [W13 R0](../01-inventory-and-ledger.md), finalized in [Phase 2](../02-coverage-decisions-and-batch-map.md). This ledger inventories the current guide surface first, records the historical discovery pass second, and now carries the final guide outcomes that drive the delivery map.
...
| --- | --- | --- | --- | --- | --- |
| [Installing Make Docs](../../../../../docs/assets/user/getting-started-installing-make-docs.md) | user | `getting-started` | `draft` | install, sync, first-run defaults, capability reference, command reference, troubleshooting | Strong overlap with install, sync, reconfigure, and basic CLI lifecycle surfaces; likely too broad once dedicated CLI guides exist |
| [Understanding W/R/P Coordinates](../../../../../docs/assets/user/concepts-wave-revision-phase-coordinates.md) | user | `concepts` | `draft` | coordinate semantics, where coordinates appear, commit-message usage | Solid concept coverage, but needs alignment with the broader stage-model and route-selection guide set |
| [How Make Docs Stages Fit Together](../../../../../docs/assets/user/workflows-how-make-docs-stages-fit-together.md) | user | `workflows` | `draft` | stage sequence, route overview, full-vs-delta outcomes | Partial overlap with route-selection guides; decomposition terminology may need tightening after `W12 R0` |
| [Choosing the Right Route for Your Project](../../../../../docs/assets/user/workflows-choosing-the-right-route-for-your-project.md) | user | `workflows` | `draft` | route selection for baseline PRDs, decomposition, targeted PRD updates, and backlog scope | Strong overlap with the developer route guide; likely needs clearer cross-links instead of duplicated prose |
| [Building and Installing the CLI Locally](../../../../../docs/assets/maintainer/cli-development-local-build-and-install.md) | developer | `cli/development` | `draft` | local build, test, instruction-router validation, smoke-pack, npm link and npm pack workflows | Mixes local CLI development with broader validation and release concerns that likely deserve separate maintainer or release guides |
| [Understanding the Make Docs Stage Model](../../../../../docs/assets/maintainer/development-workflows-stage-model-and-artifact-relationships.md) | developer | `development/workflows` | `draft` | stage model, artifact relationships, lifecycle rules, contributor implications | Strong partial overlap with coordinate and route guides; should stay as the maintainer-facing workflow explainer |
| [Choosing the Right Make Docs Route](../../../../../docs/assets/maintainer/development-workflows-choosing-the-right-route.md) | developer | `development/workflows` | `draft` | route decision table, baseline generation, decomposition, active-set evolution, W/R follow-up work | Overlaps with the user route guide; good candidate for shared cross-linking instead of standalone expansion |
| [Strategic Roadmap — Skills, Agentics, Multi-Harness, and Extensibility](../../../../../docs/assets/maintainer/roadmap.md) | developer | `roadmap` | `draft` | strategic direction for skills packaging, multi-harness support, and extensibility | Intentionally strategic, not operational; should not absorb maintainer, release, or skill-usage guides |
...
- Design docs reviewed: [Docs Contract v2 — Planning Proposals](../../../../../docs/designs/2026-04-15-docs-contract-v2-planning.md), [Docs Contract v2 — Execution Plan](../../../../../docs/designs/2026-04-15-docs-contract-v2-execution.md), [Guide Structure Contract](../../../designs/2026-04-16-guide-structure-contract.md), [Design Naming Simplification](../../../designs/2026-04-16-design-naming-simplification.md), [Asset Pipeline Completeness](../../../designs/2026-04-16-asset-pipeline-completeness.md).
...
- History records reviewed: [W2 R0 P1](../../../history/2026-04-16-w2-r0-p1-guide-structure-contract.md), [W2 R0 P5](../../../history/2026-04-16-w2-r0-p5-guide-structure-contract.md), [W3 R0 P1](../../../history/2026-04-16-w3-r0-p1-design-naming-simplification.md), [W4 R0 P1](../../../history/2026-04-16-w4-r0-p1-asset-pipeline-completeness.md).
...
- History records reviewed: [W5 R0 P1](../../../history/2026-04-16-w5-r0-p1-archive-docs-plugin.md), [W5 R2 P1](../../../history/2026-04-16-w5-r2-p1-cli-skill-installation.md), [W5 R3 P1](../../../history/2026-04-17-w5-r3-p1-cli-skill-installation.md), [W6 R0 P1](../../../history/2026-04-16-w6-r0-p1-validator-false-positive-links.md), [W7 R0 P1](../../../history/2026-04-18-w7-r0-p1-cli-help-backup-and-uninstall.md), [W7 R1 P1](../../../history/2026-04-22-w7-r1-p1-cli-lifecycle-clack-standardization.md), [W8 R0 P1](../../../history/2026-04-20-w8-r0-p1-cli-command-simplification.md).
...
- History records reviewed: [W9 R0 P1](../../../history/2026-04-20-w9-r0-p1-contracts-and-history-namespace.md), [W9 R1 P1](../../../history/2026-04-22-w9-r1-p1-resource-contract-and-routing.md), [W10 R0 P1](../../../history/2026-04-21-w10-r0-p1-core-package-and-cli-identity.md), [W11 R0 P1](../../../history/2026-04-22-w11-r0-p1-cli-skills-command.md), [W11 R0 P4](../../../history/2026-04-22-w11-r0-p4-cli-skills-command.md).
- Current-truth validation for these rows was anchored to the active PRD set, especially [PRD index](../../../../../docs/prd/00-index.md), [01 Product Overview](../../../../../docs/prd/01-product-overview.md), [05 Installation, Profile, and Manifest Lifecycle](../../../../../docs/prd/05-installation-profile-and-manifest-lifecycle.md), [06 Template Contracts and Generated Assets](../../../../../docs/prd/06-template-contracts-and-generated-assets.md), [07 CLI Command Surface and Lifecycle](../../../../../docs/prd/07-cli-command-surface-and-lifecycle.md), [08 Skills Catalog and Distribution](../../../../../docs/prd/08-skills-catalog-and-distribution.md), [09 Dogfood and Maintainer Operations](../../../../../docs/prd/09-dogfood-and-maintainer-operations.md), and [10 Packaging, Validation, and Release Reference](../../../../../docs/prd/10-packaging-validation-and-release-reference.md).
...
- `evidence links`: [Guide Structure Contract design](../../../designs/2026-04-16-guide-structure-contract.md), [W2 R0 plan](../../../plans/2026-04-16-w2-r0-guide-structure-contract/00-overview.md), [W2 R0 work](../../2026-04-16-w2-r0-guide-structure-contract/00-index.md), [W2 history](../../../history/2026-04-16-w2-r0-p1-guide-structure-contract.md), [guide contract reference](../../../../system/contracts/guide-contract.md).
...
- `final outcome`: `developer`
- `guide family`: `template and contracts`
- `developer guide action`: create `docs/guides/developer/template-contracts-guide-authoring.md`.
- `user guide action`: `none`; users consume guides rather than maintaining the guide-authoring contract.
- `suggested guide path/title`: `template/contracts / Guide Contracts and Authoring for make-docs`.
- `priority`: `P2`
- `decision notes`: This row serves maintainers authoring or extending the guide library. It needs a dedicated developer contract guide instead of user-facing coverage.
- `related docs`: [guides router](../../../../../docs/assets/AGENTS.md), guide developer template (historical path: `../../../../templates/guide-developer.md`), guide user template (historical path: `../../../../templates/guide-user.md`), [history record contract](../../../../system/contracts/history-record-contract.md).
...
- `evidence links`: [Docs Contract v2 — Planning Proposals](../../../../../docs/designs/2026-04-15-docs-contract-v2-planning.md), [Design Naming Simplification design](../../../designs/2026-04-16-design-naming-simplification.md), [W3 R0 plan](../../../plans/2026-04-16-w3-r0-design-naming-simplification/00-overview.md), [W3 R0 work](../../2026-04-16-w3-r0-design-naming-simplification/00-index.md), [user coordinate guide](../../../../../docs/assets/user/concepts-wave-revision-phase-coordinates.md), [developer stage-model guide](../../../../../docs/assets/maintainer/development-workflows-stage-model-and-artifact-relationships.md), [wave-model reference](../../../../system/references/wave-model.md).
...
- `final outcome`: `both`
- `guide family`: `concepts and workflows`
- `developer guide action`: update `docs/guides/developer/development-workflows-stage-model-and-artifact-relationships.md`.
- `user guide action`: update `docs/guides/user/concepts-wave-revision-phase-coordinates.md` and `docs/guides/user/workflows-how-make-docs-stages-fit-together.md`.
- `suggested guide path/title`: `concepts / Understanding W/R/P Coordinates`, `workflows / How Make Docs Stages Fit Together`, and `development/workflows / Understanding the Make Docs Stage Model`.
- `priority`: `P1`
- `decision notes`: `both` is justified here because users need a navigation and terminology mental model, while developers need the artifact-relationship and contributor-facing workflow rules.
- `related docs`: [user stage workflow guide](../../../../../docs/assets/user/workflows-how-make-docs-stages-fit-together.md), [PRD index](../../../../../docs/prd/00-index.md), [01 Product Overview](../../../../../docs/prd/01-product-overview.md), [02 Architecture Overview](../../../../../docs/prd/02-architecture-overview.md).
...
- `final outcome`: `both`
- `guide family`: `concepts and workflows`
- `developer guide action`: update `docs/guides/developer/development-workflows-choosing-the-right-route.md`.
- `user guide action`: update `docs/guides/user/workflows-choosing-the-right-route-for-your-project.md`.
- `suggested guide path/title`: `workflows / Choosing the Right Route for Your Project` and `development/workflows / Choosing the Right Make Docs Route`.
- `priority`: `P1`
- `decision notes`: Route choice stays in the workflow family. The concrete `decompose-codebase` skill entry point and outputs are handled in L08 and connected through cross-bundle links rather than duplicated here.
- `related docs`: [W12 PRD decomposition work](../../2026-04-23-w12-r0-make-docs-prd-decomposition/03-skills-and-cli-lifecycle.md), [08 Skills Catalog and Distribution](../../../../../docs/prd/08-skills-catalog-and-distribution.md), [03 Open Questions and Risk Register](../../../../../docs/prd/03-open-questions-and-risk-register.md).
...
- `final outcome`: `user`
- `guide family`: `onboarding`
- `developer guide action`: `none` as a standalone target; maintainer implications are covered by L10 and L12.
- `user guide action`: update `docs/guides/user/getting-started-installing-make-docs.md`.
- `suggested guide path/title`: `getting-started / Installing Make Docs`.
- `priority`: `P1`
- `decision notes`: This remains the primary user entry path. The onboarding guide should narrow to first install, first apply, and capability selection, then hand ongoing lifecycle operations to the CLI guide from L05.
- `related docs`: [01 Product Overview](../../../../../docs/prd/01-product-overview.md), [02 Architecture Overview](../../../../../docs/prd/02-architecture-overview.md), [manifest lifecycle PRD](../../../../../docs/prd/05-installation-profile-and-manifest-lifecycle.md).
...
- `final outcome`: `user`
- `guide family`: `CLI lifecycle`
- `developer guide action`: `link-only` coverage inside `docs/guides/developer/release-packaging-validation-and-release-reference.md`.
- `user guide action`: create `docs/guides/user/cli-lifecycle-managing-installations.md`.
- `suggested guide path/title`: `cli/lifecycle / Managing Installations with the Make Docs CLI`.
- `priority`: `P1`
- `decision notes`: The command and recovery workflow belongs in one user-facing lifecycle guide. The maintainer-facing audit and safety nuances should be absorbed by release and validation docs instead of spawning a separate developer CLI lifecycle guide.
- `related docs`: [current `cli.ts`](../../../../../../packages/cli/src/cli.ts), [10 Packaging, Validation, and Release Reference](../../../../../docs/prd/10-packaging-validation-and-release-reference.md), [history W7 R0 P3](../../../history/2026-04-18-w7-r0-p3-cli-help-backup-and-uninstall.md).
...
- `evidence links`: [CLI Skill Installation](../../../designs/2026-04-16-cli-skill-installation.md), [CLI Skill Installation R2](../../../designs/2026-04-16-cli-skill-installation-r2.md), [CLI Skill Selection UX — Default and Optional Groups](../../../designs/2026-04-17-cli-skill-selection-default-and-optional-groups.md), [CLI Skills Command - Skills-Only Lifecycle Surface](../../../designs/2026-04-21-cli-skills-command.md), [W5 R2 plan](../../../plans/2026-04-16-w5-r2-cli-skill-installation/00-overview.md), [W11 R0 work](../../2026-04-21-w11-r0-cli-skills-command/00-index.md), [08 Skills Catalog and Distribution](../../../../../docs/prd/08-skills-catalog-and-distribution.md), [current `skills-command.ts`](../../../../../../packages/cli/src/skills-command.ts), [current `skill-catalog.ts`](../../../../../../packages/cli/src/skill-catalog.ts), [current `skill-registry.ts`](../../../../../../packages/cli/src/skill-registry.ts).
- `existing guide overlap`: Only strategic overlap in [roadmap](../../../../../docs/assets/maintainer/roadmap.md). No current guide explains how to use or maintain the skills lifecycle surface.
- `final outcome`: `both`
- `guide family`: `skills`
- `developer guide action`: create `docs/guides/developer/skills-catalog-and-distribution-model.md`.
- `user guide action`: create `docs/guides/user/skills-installing-and-managing-skills.md`.
- `suggested guide path/title`: `skills / Installing and Managing Skills` and `skills / Skills Catalog and Distribution Model`.
- `priority`: `P1`
- `decision notes`: `both` is required because users need command and scope guidance, while maintainers need the registry, harness, and distribution model explained as a separate developer surface.
- `related docs`: [07 CLI Command Surface and Lifecycle](../../../../../docs/prd/07-cli-command-surface-and-lifecycle.md), [roadmap](../../../../../docs/assets/maintainer/roadmap.md), [current `cli.ts`](../../../../../../packages/cli/src/cli.ts).
...
- `evidence links`: [Archive Docs — Relationship-Aware Document Archival Plugin](../../../designs/2026-04-16-archive-docs-skill.md), [W5 R0 plan](../../../plans/2026-04-16-w5-r0-archive-docs-plugin/00-overview.md), [W5 R0 work](../../2026-04-16-w5-r0-archive-docs-plugin/00-index.md), [W5 history](../../../history/2026-04-16-w5-r0-p1-archive-docs-plugin.md), [08 Skills Catalog and Distribution](../../../../../docs/prd/08-skills-catalog-and-distribution.md), [roadmap](../../../../../docs/assets/maintainer/roadmap.md).
...
- `final outcome`: `link-only`
- `guide family`: `skills`
- `developer guide action`: `link-only` coverage inside `docs/guides/developer/skills-catalog-and-distribution-model.md`.
- `user guide action`: `link-only` coverage inside `docs/guides/user/skills-installing-and-managing-skills.md`.
- `suggested guide path/title`: `skills / Installing and Managing Skills` and `skills / Skills Catalog and Distribution Model`.
- `priority`: `P2`
- `decision notes`: `archive-docs` ships by default, but the surface is narrow enough to start as a documented shipped-skill section instead of a standalone guide.
- `related docs`: [current `skill-registry.ts`](../../../../../../packages/cli/src/skill-registry.ts), [packages/skills/archive-docs](../../../../../packages/skills/archive-docs), [guide roadmap](../../../../../docs/assets/maintainer/roadmap.md).
...
- `final outcome`: `user`
- `guide family`: `skills`
- `developer guide action`: `link-only` references from `docs/guides/developer/development-workflows-choosing-the-right-route.md` and `docs/guides/developer/skills-catalog-and-distribution-model.md`; no standalone developer skill guide in this phase.
- `user guide action`: create `docs/guides/user/skills-decomposing-an-existing-codebase.md`.
- `suggested guide path/title`: `skills / Decomposing an Existing Codebase`.
- `priority`: `P1`
- `decision notes`: The workflow choice remains in L03, but the concrete skill inputs, outputs, and expected artifacts need a dedicated user guide in the skills family.
...
- `final outcome`: `developer`
- `guide family`: `template and contracts`
- `developer guide action`: create `docs/guides/developer/template-assets-and-generated-routers.md`.
- `user guide action`: `none`; this is a maintainer-only implementation surface.
- `suggested guide path/title`: `template/assets / Template Assets and Generated Routers`.
- `priority`: `P1`
- `decision notes`: This is a first-stop maintainer topic for template ownership and generated output boundaries, so it merits a dedicated developer guide rather than a note buried in local CLI development docs.
- `related docs`: [guide contract reference](../../../../system/contracts/guide-contract.md), [execution workflow reference](../../../../system/references/execution-workflow.md), [packages/docs/README.md](../../../../../packages/docs/README.md), [packages/docs/template](../../../../../packages/docs/template).
...
- `evidence links`: [Docs Assets, Make-Docs State, and Session History](../../../designs/2026-04-20-docs-assets-state-and-history.md), [Docs Assets Resource Namespace Overhaul](../../../designs/2026-04-22-docs-assets-resource-namespace.md), [W9 R0 work](../../2026-04-20-w9-r0-docs-assets-state-and-history/00-index.md), [W9 R1 work](../../2026-04-22-w9-r1-docs-assets-resource-namespace/00-index.md), [W10 history](../../../history/2026-04-21-w10-r0-p3-docs-history-and-pathnames.md), [history record contract](../../../../system/contracts/history-record-contract.md), current `renderers.ts` (historical path: `../../../../../../packages/cli/src/renderers.ts`), [current `audit.ts`](../../../../../../packages/cli/src/audit.ts).
...
- `final outcome`: `developer`
- `guide family`: `maintainer and release operations`
- `developer guide action`: create `docs/guides/developer/maintainer-docs-assets-and-runtime-state-boundaries.md`.
- `user guide action`: `link-only` troubleshooting references in `docs/guides/user/getting-started-installing-make-docs.md` and `docs/guides/user/cli-lifecycle-managing-installations.md`; no standalone user guide.
- `suggested guide path/title`: `maintainer / Docs Assets and Runtime State Boundaries`.
- `priority`: `P1`
- `decision notes`: The explicit `docs/assets/**` versus `.make-docs/**` mismatch must survive into the final guide set. Current code and PRD truth win over historical W9 migration intent.
- `related docs`: [current root README](../../../../../README.md), [packages/docs/README.md](../../../../../packages/docs/README.md), [guide installing make-docs](../../../../../docs/assets/user/getting-started-installing-make-docs.md).
...
- `evidence links`: [Validator False-Positive Link Detection in Code Snippets](../../../designs/2026-04-16-validator-false-positive-links.md), [W6 R0 plan](../../../plans/2026-04-16-w6-r0-validator-false-positive-links/00-overview.md), [W6 R0 work](../../2026-04-16-w6-r0-validator-false-positive-links/00-index.md), [W6 history](../../../history/2026-04-16-w6-r0-p1-validator-false-positive-links.md), [10 Packaging, Validation, and Release Reference](../../../../../docs/prd/10-packaging-validation-and-release-reference.md).
...
- `guide family`: `maintainer and release operations`
- `developer guide action`: `link-only` coverage inside `docs/guides/developer/release-packaging-validation-and-release-reference.md`.
- `user guide action`: `none`.
- `suggested guide path/title`: `release / Packaging, Validation, and Release Reference`.
- `priority`: `P3`
- `decision notes`: This is useful maintainer context, but it is too narrow and internal to justify its own guide.
- `related docs`: [current `cli-development-local-build-and-install`](../../../../library/developer/cli-development-local-build-and-install.md), [current `packages/cli/src/README.md`](../../../../../../packages/cli/src/README.md).
...
- `evidence links`: [Make Docs Rename](../../../designs/2026-04-21-make-docs-rename.md), [W10 R0 plan](../../../plans/2026-04-21-w10-r0-make-docs-rename/00-overview.md), [W10 R0 work](../../2026-04-21-w10-r0-make-docs-rename/00-index.md), [Building and Installing the CLI Locally](../../../../../docs/assets/maintainer/cli-development-local-build-and-install.md), [09 Dogfood and Maintainer Operations](../../../../../docs/prd/09-dogfood-and-maintainer-operations.md), [10 Packaging, Validation, and Release Reference](../../../../../docs/prd/10-packaging-validation-and-release-reference.md), [current `utils.ts`](../../../../../../packages/cli/src/utils.ts), [packages/docs/README.md](../../../../../packages/docs/README.md).
...
- `final outcome`: `developer`
- `guide family`: `maintainer and release operations`
- `developer guide action`: update `docs/guides/developer/cli-development-local-build-and-install.md`; create `docs/guides/developer/maintainer-dogfood-and-maintainer-operations.md`; create `docs/guides/developer/release-packaging-validation-and-release-reference.md`.
- `user guide action`: `none`; user entry-point guides should link here only when troubleshooting or contributing.
- `suggested guide path/title`: `cli/development / Building and Installing the CLI Locally`, `maintainer / Dogfood and Maintainer Operations`, and `release / Packaging, Validation, and Release Reference`.
- `priority`: `P1`
- `decision notes`: Keep `docs/guides/developer/roadmap.md` strategic and untouched. Rename-specific history should appear only as supporting context inside the maintainer and release guides rather than as a separate operational guide.
- `related docs`: [roadmap](../../../../../docs/assets/maintainer/roadmap.md), [current root README](../../../../../README.md), [packages/cli/package.json](../../../../../packages/cli/package.json), [scripts/smoke-pack.mjs](../../../../../scripts/smoke-pack.mjs).

## Phase 2 Handoff Notes

- `resolved split`: The onboarding guide stays focused on first install and initial capability selection, while ongoing apply or sync, reconfigure, help, backup, uninstall, and recovery guidance moves to the dedicated user CLI lifecycle guide from L05.
- `resolved decomposition boundary`: Workflow choice remains in Bundle A route guides, while the concrete `decompose-codebase` skill entry point, outputs, and expectations land in Bundle C and are cross-linked later.
