...
- [01-product-overview.md](../../../../docs/prd/01-product-overview.md)
- [02-architecture-overview.md](../../../../docs/prd/02-architecture-overview.md)
...
- [x] t5: Make the playbook discoverable from the README and the `docs/` router.
