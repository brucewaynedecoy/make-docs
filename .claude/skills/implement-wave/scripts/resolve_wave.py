#!/usr/bin/env python3
"""Resolve a docs/work wave or phase coordinate for implement-wave."""
...
from implement_wave_common import WaveError, resolve_target
...
def main() -> int:
    ...
    try:
        print(json.dumps(resolve_target(args.target), indent=2, sort_keys=True))
