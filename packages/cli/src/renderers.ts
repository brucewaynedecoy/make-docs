...
function renderDesignWorkflow(profile: InstallProfile): string {
  ...
  return [
    ...
    "",
    "This workflow ends with design docs in `docs/designs/` using the form `docs/designs/YYYY-MM-DD-w{W}-r{R}-<slug>.md`. Local planning assets are not installed in this profile.",
    "",
    "## Preflight",
    "",
    "Before writing:",
