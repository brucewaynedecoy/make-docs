...
export const PERFORMANCE_EVIDENCE_RULES: readonly PerformanceEvidenceRule[] = Object.freeze([
  ...
  },
  {
    ...
    focusedTests: ["invalid identity", "duplicate live identity", "archived version history", "invalid version", "source digest"],
    parityMapping: "Both methods verify one live PERF authority and preserve append-only version history.",
    oneSidedReason: null,
  },
  {
    id: "PERF-RULE-004",
    ...
    focusedTests: ["missing field", "unresolved placeholder", "full supported scope", "full measurement protocol", "all non-sacrificable constraints"],
