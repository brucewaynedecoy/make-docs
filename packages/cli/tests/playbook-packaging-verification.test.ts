...
function writeVocabularyPlaybook(root: string): void {
  writeFile(
    ...
    [
      ...
      "| node-packages | package-manager | required | npm | work | none |",
      "| helper-script | script | optional | scripts/helper.sh | work | none |",
      "| context-server | mcp | preferred | context-mode | work | continue without extra context |",
      "| issue-tracker | external-service | optional | https://example.test/api | work | manual updates |",
      "| review-guide | reference | required | .make-docs/contracts/system/example.md | work | none |",
      "| commit-helper | skill | preferred | commit-helper | work | manual commit |",
      "| formatter-plugin | plugin | optional | prettier-plugin | work | manual formatting |",
      "| child-run | playbook | optional | user/child-run | work | skip |",
      "| brand-logo | asset | optional | docs/assets/artifacts/logo.png | work | none |",
      "",
      "## Workflow Contract",
      "",
      "```playbook",
