...
For requested durable run progress, use the [Store reference](references/store.md). It is operation guidance, not an invocation of the factory skill. Do not create a parallel state file, tally, or gate system. Do not make capture a prerequisite for an ordinary review.
