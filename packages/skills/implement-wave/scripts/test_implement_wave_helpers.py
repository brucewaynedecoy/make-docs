#!/usr/bin/env python3
"""Tests for implement-wave helper scripts."""
...
from implement_wave_common import parse_phase, resolve_target, save_state, state_path_for  # noqa: E402
from phase_gate import build_gate_report  # noqa: E402
from scope_guard import build_scope_report  # noqa: E402


class ImplementWaveHelperTests(unittest.TestCase):
    def setUp(self) -> None:
        self.temp_dir = Path(tempfile.mkdtemp(prefix="implement-wave-test-"))
