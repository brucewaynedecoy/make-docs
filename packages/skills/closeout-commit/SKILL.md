...
2. Run `make-docs operations closeout-probe --repo-root . --scope SCOPE --json` with the selected scope before inspecting broad diffs or reference docs manually.
