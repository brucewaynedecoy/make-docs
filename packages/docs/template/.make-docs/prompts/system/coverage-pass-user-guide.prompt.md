...
Close with a concise pass summary: verdict table, artifacts changed, validation run, no-change rationales, and remaining handoffs. If commit-message work is needed, use the existing `.make-docs/prompts/system/work-to-commit-message.prompt.md`; do not create a duplicate commit-message starter.
