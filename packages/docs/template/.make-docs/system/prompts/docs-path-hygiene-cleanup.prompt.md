...
Before editing anything, read `.make-docs/manifest.json`, `docs/AGENTS.md`, and `.make-docs/system/references/path-and-link-hygiene.md`. Treat the path hygiene reference as the authority for project-relative paths, relative Markdown links, sanitized placeholders, and full-path exceptions.
