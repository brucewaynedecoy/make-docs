...
Before drafting or committing, read `.make-docs/system/contracts/commit-message-convention.md`. Use it as the authority for subject shape, body source, and commit execution rules.
...
- `.make-docs/archive/history/` for current breadcrumb records
