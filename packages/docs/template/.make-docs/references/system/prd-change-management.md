...
| --- | --- | --- | --- |
| `addition` | Introduces a net-new capability that was not previously required | `.make-docs/templates/system/prd-change-addition.md` | None required unless baseline docs need cross-links |
| `enhancement` | Extends an existing capability with new behavior or scope | `.make-docs/templates/system/prd-change-addition.md` | `Enhanced by` |
| `revision` | Changes an established requirement, contract, or constraint | `.make-docs/templates/system/prd-change-revision.md` | `Superseded by` |
| `removal` | Deprecates or removes an established requirement or capability | `.make-docs/templates/system/prd-change-revision.md` | `Deprecated by` or `Removed by` |
