...
Then inspect the active PRD namespace in `docs/prd/` and create a detailed change plan in `docs/plans/`. Follow the instructions, references, and templates in the `docs` directory, especially `.make-docs/references/system/wave-model.md` and `.make-docs/references/system/prd-change-management.md`.
