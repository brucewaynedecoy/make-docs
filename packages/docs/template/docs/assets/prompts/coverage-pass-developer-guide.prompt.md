...
Inspect existing guides under `docs/guides/developer/` and related user guides under `docs/guides/user/`. Enumerate every candidate developer-facing capability, workflow, validation path, contract, extension point, operator task, or troubleshooting item from the completed work.
