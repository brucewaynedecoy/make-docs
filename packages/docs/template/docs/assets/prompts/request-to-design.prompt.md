...
Follow the instructions, references, and templates in the `docs` directory, especially `docs/assets/references/design-workflow.md`, `docs/assets/references/design-contract.md`, and `docs/assets/templates/design.md`.
