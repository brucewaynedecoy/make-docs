...
This directory is the authoritative source for workflow rules and output contracts.
...
- Use `coverage-pass-contract.md` for shared coverage-pass skeleton, verdict mapping, persona-target separation, history idempotency, and close-of-pass validation rules.
