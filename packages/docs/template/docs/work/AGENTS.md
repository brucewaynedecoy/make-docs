...
- Before writing, read `docs/.references/execution-workflow.md` and copy the matching template from `docs/.templates/` (`work-index.md` for `00-index.md`; `work-phase.md` for phase files).
- Always create work as a directory; never a flat `.md` file.
- Apply the date-W/R-slug naming; do not backdate.
- Archived backlogs live in `docs/.archive/work/`. **Never archive unless explicitly asked.** See `docs/.archive/AGENTS.md`.
